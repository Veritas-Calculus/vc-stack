...
func (s *Service) seedDefaults() {
	cats := []Category{
		{ID: uuid.New().String(), Name: "compute", Icon: "monitor", Description: "Virtual machines, containers, and bare metal servers", SortOrder: 1},
		{ID: uuid.New().String(), Name: "storage", Icon: "hard-drive", Description: "Block, object, and file storage services", SortOrder: 2},
		{ID: uuid.New().String(), Name: "networking", Icon: "globe", Description: "Virtual networks, load balancers, DNS, and VPN", SortOrder: 3},
		{ID: uuid.New().String(), Name: "databases", Icon: "database", Description: "Managed database instances", SortOrder: 4},
		{ID: uuid.New().String(), Name: "security", Icon: "lock", Description: "Identity management, encryption, and compliance", SortOrder: 5},
		{ID: uuid.New().String(), Name: "containers", Icon: "box", Description: "Kubernetes clusters and container orchestration", SortOrder: 6},
	}
	...
	items := []CatalogItem{
		...
		{ID: uuid.New().String(), CategoryID: catMap["compute"], Name: "vm-standard", DisplayName: "Standard VM",
			...
			Icon:        "monitor", PriceUnit: "hour", PriceAmount: 0.05, Specs: `{"vcpu":2,"ram_gb":4,"disk_gb":40}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["compute"], Name: "vm-performance", DisplayName: "Performance VM",
			...
			Icon:        "zap", PriceUnit: "hour", PriceAmount: 0.20, Specs: `{"vcpu":8,"ram_gb":32,"disk_gb":200,"disk_type":"nvme"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["compute"], Name: "vm-gpu", DisplayName: "GPU Accelerated VM",
			...
			Icon:        "gpu", PriceUnit: "hour", PriceAmount: 2.50, Specs: `{"vcpu":16,"ram_gb":64,"disk_gb":500,"gpu":"A100-40GB"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["compute"], Name: "bare-metal-standard", DisplayName: "Bare Metal Server",
			...
			Icon:        "server", PriceUnit: "month", PriceAmount: 450.00, Specs: `{"cpu_cores":32,"ram_gb":256,"disk_tb":4,"disk_type":"nvme"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["storage"], Name: "block-ssd", DisplayName: "SSD Block Storage",
			...
			Icon:        "disc", PriceUnit: "GB", PriceAmount: 0.10, Specs: `{"iops_max":10000,"throughput_mbps":250,"type":"ssd"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["storage"], Name: "object-s3", DisplayName: "S3 Object Storage",
			...
			Icon:        "archive", PriceUnit: "GB", PriceAmount: 0.023, Specs: `{"durability":"11-nines","api":"s3-compatible"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["networking"], Name: "vpc-network", DisplayName: "Virtual Private Cloud",
			...
			Icon:        "globe", PriceUnit: "month", PriceAmount: 0, Specs: `{"max_subnets":16,"max_security_groups":50}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["networking"], Name: "load-balancer", DisplayName: "Load Balancer",
			...
			Icon:        "scale", PriceUnit: "hour", PriceAmount: 0.025, Specs: `{"layers":["L4","L7"],"ssl":true,"health_checks":true}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["databases"], Name: "db-postgresql", DisplayName: "Managed PostgreSQL",
			...
			Icon:        "database", PriceUnit: "hour", PriceAmount: 0.08, Specs: `{"engine":"PostgreSQL 16","ha":true,"backup":"daily","pitr":true}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["databases"], Name: "db-redis", DisplayName: "Managed Redis",
			...
			Icon:        "database", PriceUnit: "hour", PriceAmount: 0.04, Specs: `{"engine":"Redis 7","cluster":true,"persistence":true}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["security"], Name: "kms-key", DisplayName: "Encryption Key (KMS)",
			...
			Icon:        "key", PriceUnit: "month", PriceAmount: 1.0, Specs: `{"algorithm":"AES-256-GCM","rotation":"automatic"}`,
		...
		{ID: uuid.New().String(), CategoryID: catMap["containers"], Name: "k8s-cluster", DisplayName: "Kubernetes Cluster",
			...
			Icon:        "kubernetes", PriceUnit: "hour", PriceAmount: 0.10, Specs: `{"k8s_version":"v1.29","cni":"calico","autoscale":true}`,
