...
func (s *Service) SetupRoutes(router *gin.Engine) {
	...
	api.Any("/v1/sso/providers", s.proxyHandler("identity"))
	api.Any("/v1/sso/providers/*path", s.proxyHandler("identity"))
	api.Any("/v1/sso/users", s.proxyHandler("identity"))
	api.Any("/v1/sso/users/*path", s.proxyHandler("identity"))
