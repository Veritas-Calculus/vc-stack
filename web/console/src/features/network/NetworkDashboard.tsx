                ...
                <div className="card p-4 space-y-3">
                    ...
                    <div className="flex gap-4 flex-wrap">
                        {stats.network_status.map(ns => {
                            const variant = ns.status === 'active' ? 'bg-green-500/20 text-green-400' :
                                ns.status === 'creating' ? 'bg-yellow-500/20 text-yellow-400' :
                                    ns.status === 'error' ? 'bg-red-500/20 text-red-400' :
