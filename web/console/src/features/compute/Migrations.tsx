        ...
        <div className="space-y-4">
            ...
            {loading ? (
                ...
                <div className="text-center py-12 text-gray-500">
                    ...
                    <div className="text-sm">Migrations appear here when an instance is migrated between hosts</div>
                </div>
            ) : (
                <div className="space-y-3">
                    {migrations.map(m => (
                        <div key={m.id} className="p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/[0.07] transition-colors">
