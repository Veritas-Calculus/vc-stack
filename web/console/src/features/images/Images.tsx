...
export function Images() {
  ...
  const cols: Column<UIImage>[] = [
    ...
    { key: 'sizeGiB', header: 'Size (GiB)' },
    {
      ...
      header: 'Status',
      render: (r) => (
        <Badge variant={r.status === 'available' || r.status === 'active' ? 'success' : 'info'}>
          {r.status}
        </Badge>
      )
    },
          ...
          <>
            ...
            <button
              ...
              onClick={async () => {
                ...
                setBusy(true)
                try {
                  const body: Parameters<typeof registerImage>[0] = {
                    name,
                  ...
                  if (rbdPool && rbdImage) {
                    body.rbd_pool = rbdPool
                    body.rbd_image = rbdImage
                    if (rbdSnap) body.rbd_snap = rbdSnap
                  }
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <input
                ...
                value={rgwUrl}
                onChange={(e) => setRgwUrl(e.target.value)}
              />
            </div>
            <div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="vcpool"
                  value={rbdPool}
                  onChange={(e) => setRbdPool(e.target.value)}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value={rbdImage}
                  onChange={(e) => setRbdImage(e.target.value)}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="base"
                  value={rbdSnap}
                  onChange={(e) => setRbdSnap(e.target.value)}
                />
              </div>
            </div>
