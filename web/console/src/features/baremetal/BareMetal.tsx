...
export function BareMetal() {
  ...
  const badge = (s: string) => {
    const m: Record<string, string> = {
      ...
      hdd: 'bg-gray-500/20 text-gray-400',
          ...
          <div className="grid grid-cols-5 gap-4">
            {[
              ...
              },
              {
                ...
                icon: Icons.statusDot('w-3 h-3 text-blue-400'),
                color: 'text-blue-400'
              },
              {
                label: 'CPU Cores',
            ...
            <div className="grid gap-4">
              {Object.entries(
                ...
                <div key={rack} className="bg-gray-700/20 border border-gray-700/30 rounded-lg p-4">
                  <div className="text-xs text-gray-400 mb-3 uppercase font-semibold flex items-center gap-1">
                    ...
                    {(srvs as BMServer[])
                      ...
                      .map((srv) => (
                        <div
                          ...
                          className="flex items-center justify-between p-3 bg-gray-800/60 border border-gray-700/30 rounded-lg cursor-pointer hover:border-blue-500/40 transition"
                        >
        ...
        <div className="grid gap-3">
          {servers.map((srv) => (
            <div
              ...
              className="bg-gray-800/60 border border-gray-700/40 rounded-xl p-4 cursor-pointer hover:border-blue-500/40 transition"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-lg flex items-center justify-center text-xl ${srv.power_status === 'on' ? 'bg-emerald-500/20' : 'bg-gray-700/40'}`}
                  >
          ...
          <div className="bg-gray-800/60 border border-gray-700/40 rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-700/20 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-300 space-y-1">
                  <div>
                    MAC: <span className="font-mono text-white">{serverDetail.primary_mac}</span>
                  </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1.5 bg-emerald-600 text-white rounded text-xs hover:bg-emerald-500 transition flex items-center gap-1"
              >
              ...
              <button
                ...
                className="px-3 py-1.5 bg-amber-600 text-white rounded text-xs hover:bg-amber-500 transition"
              >
                Cycle
              </button>
              <button
                onClick={() => doPower(serverDetail.id, 'reset')}
                className="px-3 py-1.5 bg-gray-600 text-white rounded text-xs hover:bg-gray-500 transition"
              >
                Reset
              </button>
              {serverDetail.status === 'available' && (
                <button
                  ...
                  className="px-3 py-1.5 bg-purple-600 text-white rounded text-xs hover:bg-purple-500 transition ml-auto"
                >
                  Provision
                </button>
              )}
