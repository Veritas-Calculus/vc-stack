...
export function Projects() {
  ...
  const columns: Column<ProjectRow>[] = [
    ...
    { key: 'id', header: 'ID', className: 'text-gray-400 text-xs font-mono' },
    ...
    <div className="space-y-4">
      ...
      {selectedProject && (
        ...
        >
          ...
          <div
            className="relative w-full max-w-lg bg-oxide-900 border-l border-oxide-800 shadow-2xl h-full overflow-y-auto"
          ...
          >
            ...
            <div className="p-6 space-y-3">
              {/* Add Member Form */}
              {showAddMember && (
                <div className="rounded-xl border border-oxide-700 bg-oxide-800/50 p-4 space-y-3 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-2 py-1.5 rounded border border-oxide-600 bg-oxide-900 text-gray-200 text-sm"
                      >
                  ...
                  <div className="flex gap-2 justify-end">
                    ...
                    <button
                      ...
                      disabled={!addUserId}
                      className="px-3 py-1 rounded text-xs bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-50"
                    >
                      Add
                    </button>
                  </div>
              ...
              {membersLoading ? (
                ...
                members.map((m) => (
                  <div
                    key={m.id}
                    className="flex items-center justify-between px-4 py-3 rounded-xl border border-oxide-800 bg-oxide-800/30 hover:bg-oxide-800/50 transition-colors"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        className="px-2 py-1 rounded border border-oxide-600 bg-oxide-900 text-gray-300 text-xs"
                      >
                        <option value="admin">Admin</option>
                        <option value="member">Member</option>
                        <option value="viewer">Viewer</option>
