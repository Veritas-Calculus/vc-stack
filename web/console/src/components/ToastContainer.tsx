  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 space-y-2 w-[min(360px,calc(100vw-2rem))]">
      {toasts.map((t) => (
        <div
          key={t.id}
          className={`rounded-lg border shadow-glass-sm backdrop-blur-xl p-3 text-sm flex items-start gap-2 animate-slide-in ${
            t.variant === 'success'
        ...
        >
          <div className="mt-0.5">
            ...
            {t.variant === 'error' && (
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L1 21h22L12 2zm0 14h-1v-1h1v1zm0-3h-1V8h1v5z" />
              </svg>
            )}
            {t.variant === 'info' && (
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
