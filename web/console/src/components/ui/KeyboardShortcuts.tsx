            ...
            <div className="relative w-full max-w-lg rounded-2xl border border-oxide-700 bg-oxide-900 shadow-2xl animate-scale-in overflow-hidden">
                                        ...
                                        <div className="flex items-center gap-1">
                                            {item.keys.map((key, i) => (
                                                <span key={i}>
                                                    ...
                                                    {i < item.keys.length - 1 && <span className="text-gray-600 mx-0.5">+</span>}
                                                </span>
                                            ))}
                                        </div>
                                    </div>
                ...
                <div className="px-5 py-3 border-t border-oxide-800 text-center">
                    <p className="text-xs text-gray-600">
                        Press <kbd className="px-1.5 py-0.5 rounded text-[10px] font-mono bg-oxide-800 border border-oxide-700 text-gray-400">?</kbd> to toggle this panel
                    </p>
                </div>
            </div>
        </div>
