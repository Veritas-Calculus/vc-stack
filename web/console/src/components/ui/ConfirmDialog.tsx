            ...
            <div className="relative w-full max-w-md rounded-2xl border border-oxide-700 bg-oxide-900 shadow-2xl animate-scale-in">
                ...
                <div className="p-6 pb-4">
                    <div className="flex items-start gap-4">
                        <div className={`shrink-0 w-10 h-10 rounded-xl ${v.bg} ${v.border} border grid place-items-center`}>
                            {v.icon}
                        </div>
                        <div>
                    ...
                    <div className="px-6 pb-4">
                        <div className="p-3 rounded-xl bg-oxide-800/50 border border-oxide-700">
                            <p className="text-xs text-gray-400 mb-2">
                                Type <span className="font-mono text-white font-semibold px-1.5 py-0.5 rounded bg-oxide-700">{confirmText}</span> to confirm:
                            </p>
                            <input
                                ref={inputRef}
                                type="text"
