import { g as Se } from './react-vendor-B-2j4S7D.js'
function Ce(se, le) {
    ...
    if (typeof J != 'string' && !Array.isArray(J)) {
      for (const V in J)
        if (V !== 'default' && !(V in se)) {
          ...
          te && Object.defineProperty(se, V, te.get ? te : { enumerable: !0, get: () => J[V] })
        }
    }
  }
          ...
          4567: function (I, r, a) {
            var c =
                ...
                function (i, o, l, v) {
                  var m,
                    h = arguments.length,
                    g = h < 3 ? o : v === null ? (v = Object.getOwnPropertyDescriptor(o, l)) : v
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    g = Reflect.decorate(i, o, l, v)
                  else
                    for (var b = i.length - 1; b >= 0; b--)
                      (m = i[b]) && (g = (h < 3 ? m(g) : h > 3 ? m(o, l, g) : m(o, l)) || g)
            ...
            let t = (r.AccessibilityManager = class extends p.Disposable {
              constructor(i, o) {
                ...
                ;(this._terminal.element.insertAdjacentElement(
                  ...
                  this.register(this._terminal.onResize((l) => this._handleResize(l.rows))),
                  this.register(this._terminal.onRender((l) => this._refreshRows(l.start, l.end))),
                  this.register(this._terminal.onScroll(() => this._refreshRows())),
                  this.register(this._terminal.onA11yChar((l) => this._handleChar(l))),
                  this.register(
...
`)
                  ...
                  this.register(this._terminal.onA11yTab((l) => this._handleTab(l))),
                  this.register(this._terminal.onKey((l) => this._handleKey(l.key))),
                  this.register(this._terminal.onBlur(() => this._clearLiveRegion())),
                  this.register(
                    this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())
                  ),
                  (this._screenDprMonitor = new u.ScreenDprMonitor(window)),
              ...
              _handleChar(i) {
                this._liveRegionLineCount < 21 &&
                  (this._charsToConsume.length > 0
                    ? this._charsToConsume.shift() !== i && (this._charsToAnnounce += i)
...
` &&
              ...
              _renderRows(i, o) {
                ...
                for (let m = i; m <= o; m++) {
                  const h = l.translateBufferLineToString(l.ydisp + m, !0),
                    g = (l.ydisp + m + 1).toString(),
                    b = this._rowElements[m]
                  b &&
                    (h.length === 0 ? (b.innerText = ' ') : (b.textContent = h),
              ...
              _handleBoundaryFocus(i, o) {
                const l = i.target,
                  v = this._rowElements[o === 0 ? 1 : this._rowElements.length - 2]
                if (
                ...
                if (
                  (o === 0
                    ? ((m = l), (h = this._rowElements.pop()), this._rowContainer.removeChild(h))
                    : ((m = this._rowElements.shift()), (h = l), this._rowContainer.removeChild(m)),
                  m.removeEventListener('focus', this._topBoundaryFocusListener),
                  h.removeEventListener('focus', this._bottomBoundaryFocusListener),
                  o === 0)
                ) {
                  const g = this._createAccessibilityTreeNode()
                  ;(this._rowElements.unshift(g),
                    this._rowContainer.insertAdjacentElement('afterbegin', g))
                } else {
                  const g = this._createAccessibilityTreeNode()
                ...
                ;(this._rowElements[0].addEventListener('focus', this._topBoundaryFocusListener),
                  ...
                  this._rowElements[o === 0 ? 1 : this._rowElements.length - 2].focus(),
                  i.preventDefault(),
              ...
              _handleResize(i) {
                ...
                for (let o = this._rowContainer.children.length; o < this._terminal.rows; o++)
          ...
          3614: (I, r) => {
            ...
            function _(d, f, p, u) {
              ;((d = c(
                (d = a(d)),
                p.decPrivateModes.bracketedPasteMode && u.rawOptions.ignoreBracketedPasteMode !== !0
              )),
            ...
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              ...
              (r.handlePasteEvent = function (d, f, p, u) {
                ;(d.stopPropagation(),
                  d.clipboardData && _(d.clipboardData.getData('text/plain'), f, p, u))
              }),
              (r.paste = _),
          ...
          6465: function (I, r, a) {
            var c =
                ...
                function (e, s, t, i) {
                  var o,
                    l = arguments.length,
                    v = l < 3 ? s : i === null ? (i = Object.getOwnPropertyDescriptor(s, t)) : i
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    v = Reflect.decorate(e, s, t, i)
                  else
                    for (var m = e.length - 1; m >= 0; m--)
                      (o = e[m]) && (v = (l < 3 ? o(v) : l > 3 ? o(s, t, v) : o(s, t)) || v)
            ...
            let u = (r.Linkifier2 = class extends f.Disposable {
              ...
              _askForLink(e, s) {
                ...
                for (const [l, v] of this._linkProviders.entries())
                  s
                    ? !((i = this._activeProviderReplies) === null || i === void 0) &&
                      i.get(l) &&
                    ...
                    : v.provideLinks(e.y, (m) => {
                        ...
                        ;((h = this._activeProviderReplies) === null || h === void 0 || h.set(l, b),
                          (o = this._checkLinkProviderResult(l, e, o)),
                          ((g = this._activeProviderReplies) === null || g === void 0
                            ? void 0
                ...
                for (let i = 0; i < s.size; i++) {
                  ...
                  if (o)
                    for (let l = 0; l < o.length; l++) {
                      const v = o[l],
                        m = v.link.range.start.y < e ? 0 : v.link.range.start.x,
                        h = v.link.range.end.y > e ? this._bufferService.cols : v.link.range.end.x
                      for (let g = m; g <= h; g++) {
                        if (t.has(g)) {
                          o.splice(l--, 1)
                          break
              ...
              _checkLinkProviderResult(e, s, t) {
                ...
                let l = !1
                for (let v = 0; v < e; v++)
                  (this._activeProviderReplies.has(v) && !this._activeProviderReplies.get(v)) ||
                    (l = !0)
                if (!l && o) {
                ...
                if (this._activeProviderReplies.size === this._linkProviders.length && !t)
                  for (let v = 0; v < this._activeProviderReplies.size; v++) {
                    const m =
                      (i = this._activeProviderReplies.get(v)) === null || i === void 0
                        ? void 0
                  ...
                  Object.defineProperties(e.link.decorations, {
                    pointerCursor: {
                      get: () => {
                        var t, i
                        return (i =
                          (t = this._currentLink) === null || t === void 0 ? void 0 : t.state) ===
                          null || i === void 0
                          ? void 0
                        ...
                        !((i = this._currentLink) === null || i === void 0) &&
                          ...
                          this._currentLink.state.isHovered &&
                            ((o = this._element) === null ||
                              o === void 0 ||
                              o.classList.toggle('xterm-cursor-pointer', t)))
                      }
                    },
                    underline: {
                      get: () => {
                      ...
                      set: (t) => {
                        ...
                        !((i = this._currentLink) === null || i === void 0) &&
                          i.state &&
                          ((l =
                            (o = this._currentLink) === null || o === void 0 ? void 0 : o.state) ===
                            null || l === void 0
                            ? void 0
                    ...
                    this._linkCacheDisposables.push(
                      this._renderService.onRenderedViewportChange((t) => {
                        ...
                        const i =
                          ...
                          o = this._bufferService.buffer.ydisp + 1 + t.end
                        if (
                          this._currentLink.link.range.start.y >= i &&
                          this._currentLink.link.range.end.y <= o &&
                          (this._clearCurrentLink(i, o), this._lastMouseEvent && this._element)
                        ) {
              ...
              _linkAtPosition(e, s) {
                const t = e.range.start.y * this._bufferService.cols + e.range.start.x,
                  i = e.range.end.y * this._bufferService.cols + e.range.end.x,
          ...
          3730: function (I, r, a) {
            var c =
                ...
                function (u, e, s, t) {
                  var i,
                    o = arguments.length,
                    l = o < 3 ? e : t === null ? (t = Object.getOwnPropertyDescriptor(e, s)) : t
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    l = Reflect.decorate(u, e, s, t)
                  else
                    for (var v = u.length - 1; v >= 0; v--)
                      (i = u[v]) && (l = (o < 3 ? i(l) : o > 3 ? i(e, s, l) : i(e, s)) || l)
              ...
              provideLinks(u, e) {
                ...
                for (let b = 0; b < v; b++)
                  if (h !== -1 || t.hasContent(b)) {
                    ...
                    if (g || (h !== -1 && b === v - 1)) {
                      const L =
                        (s = this._oscLinkService.getLinkData(m)) === null || s === void 0
                          ? void 0
                          : s.uri
                      if (L) {
                        const y = {
                          start: { x: h + 1, y: u },
                          end: { x: b + (g || b !== v - 1 ? 0 : 1), y: u }
                        }
                        let k = !1
                        if (!o?.allowNonHttpProtocols)
                          try {
                            const x = new URL(L)
                            ;['http:', 'https:'].includes(x.protocol) || (k = !0)
                          } catch {
                            k = !0
                          }
                        k ||
                          i.push({
                            text: L,
                            range: y,
                            activate: (x, T) => (o ? o.activate(x, T, y) : p(0, T)),
                            hover: (x, T) => {
                              var O
                              return (O = o?.hover) === null || O === void 0
                                ? void 0
                                : O.call(o, x, T, y)
                            },
                            leave: (x, T) => {
                              var O
                              return (O = o?.leave) === null || O === void 0
                                ? void 0
                                : O.call(o, x, T, y)
                            }
                          })
...
WARNING: This link could potentially be dangerous`)
              ...
              (r.RenderDebouncer = class {
                ...
                refresh(a, c, _) {
                  ;((this._rowCount = _),
                    ...
                    (this._rowStart = this._rowStart !== void 0 ? Math.min(this._rowStart, a) : a),
            ...
            class W extends y.CoreTerminal {
              ...
              constructor(S = {}) {
                ;(super(S),
                  ...
                  (this._onCursorMove = this.register(new k.EventEmitter())),
                  ...
                  (this._onSelectionChange = this.register(new k.EventEmitter())),
                  (this.onSelectionChange = this._onSelectionChange.event),
                  (this._onTitleChange = this.register(new k.EventEmitter())),
                  ...
                  (this._onA11yCharEmitter = this.register(new k.EventEmitter())),
                  (this._onA11yTabEmitter = this.register(new k.EventEmitter())),
                  (this._onWillOpen = this.register(new k.EventEmitter())),
                  this._setup(),
                  ...
                  this.register(
                    this._inputHandler.onRequestRefreshRows((R, B) => this.refresh(R, B))
                  ),
                  this.register(this._inputHandler.onRequestSendFocus(() => this._reportFocus())),
                  this.register(this._inputHandler.onRequestReset(() => this.reset())),
                  this.register(
                    this._inputHandler.onRequestWindowsOptionsReport((R) =>
                      this._reportWindowsOptions(R)
                    )
                  ),
                  this.register(this._inputHandler.onColor((R) => this._handleColorEvent(R))),
                  this.register(
                    (0, k.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove)
                  ),
                  this.register(
                    (0, k.forwardEvent)(this._inputHandler.onTitleChange, this._onTitleChange)
                  ),
                  this.register(
                    (0, k.forwardEvent)(this._inputHandler.onA11yChar, this._onA11yCharEmitter)
                  ),
                  this.register(
                    (0, k.forwardEvent)(this._inputHandler.onA11yTab, this._onA11yTabEmitter)
                  ),
                  this.register(
                    this._bufferService.onResize((R) => this._afterResize(R.cols, R.rows))
                  ),
                  this.register(
                    (0, x.toDisposable)(() => {
                      var R, B
                      ;((this._customKeyEventHandler = void 0),
                        (B =
                          (R = this.element) === null || R === void 0 ? void 0 : R.parentNode) ===
                          null ||
                          B === void 0 ||
                      ...
                      case 1:
                        if (B === 'ansi')
                          this._themeService.modifyColors(
                            (F) => (F.ansi[R.index] = L.rgba.toColor(...R.color))
                          )
                        else {
                          const F = B
                          this._themeService.modifyColors(
              ...
              _syncTextArea() {
                ...
                const B = Math.min(this.buffer.x, this.cols - 1),
                  ...
                  j = this.buffer.y * this._renderService.dimensions.css.cell.height,
              ...
              _initGlobal() {
                ;(this._bindKeys(),
                  this.register(
                    (0, _.addDisposableDomListener)(this.element, 'copy', (R) => {
                      this.hasSelection() && (0, c.copyHandler)(R, this._selectionService)
                    })
                  ))
                const S = (R) =>
                  (0, c.handlePasteEvent)(R, this.textarea, this.coreService, this.optionsService)
                ;(this.register((0, _.addDisposableDomListener)(this.textarea, 'paste', S)),
                  this.register((0, _.addDisposableDomListener)(this.element, 'paste', S)),
                  T.isFirefox
                    ? this.register(
                        (0, _.addDisposableDomListener)(this.element, 'mousedown', (R) => {
                          R.button === 2 &&
                    ...
                    : this.register(
                        (0, _.addDisposableDomListener)(this.element, 'contextmenu', (R) => {
                          ;(0, c.rightClickHandler)(
                            R,
                            this.textarea,
                            this.screenElement,
                  ...
                  T.isLinux &&
                    this.register(
                      (0, _.addDisposableDomListener)(this.element, 'auxclick', (R) => {
                        R.button === 1 &&
                          (0, c.moveTextAreaUnderMouseCursor)(R, this.textarea, this.screenElement)
                      })
                    ))
              }
              _bindKeys() {
                ;(this.register(
                  (0, _.addDisposableDomListener)(this.textarea, 'keyup', (S) => this._keyUp(S), !0)
                ),
                  this.register(
                  ...
                  this.register(
                    (0, _.addDisposableDomListener)(this.textarea, 'compositionupdate', (S) =>
                      this._compositionHelper.compositionupdate(S)
                    )
                  ),
                  this.register(
              ...
              open(S) {
                ...
                ;((this._viewportElement = U.createElement('div')),
                  ...
                  (this._coreBrowserService = this._instantiationService.createInstance(
                    ...
                    this.textarea,
                    (R = this._document.defaultView) !== null && R !== void 0 ? R : window
                  )),
                  this._instantiationService.setService(
                  ...
                  this._instantiationService.setService(g.ICharSizeService, this._charSizeService),
                  (this._themeService = this._instantiationService.createInstance(b.ThemeService)),
                  this._instantiationService.setService(g.IThemeService, this._themeService),
                  ...
                  this._instantiationService.setService(g.IRenderService, this._renderService),
                  this.register(
                ...
                ;(this._renderService.hasRenderer() ||
                  ...
                  (this._mouseService = this._instantiationService.createInstance(v.MouseService)),
                  this._instantiationService.setService(g.IMouseService, this._mouseService),
                  ...
                  this.register(
                    this._selectionService.onRequestRedraw((A) =>
                      this._renderService.handleSelectionChanged(A.start, A.end, A.columnSelectMode)
                    )
                  ),
                  this.register(
              ...
              bindMouse() {
                const S = this,
                  R = this.element
                function B(F) {
                  const j = S._mouseService.getMouseReportCoords(F, S.screenElement)
                  if (!j) return !1
                  let q, G
                  switch (F.overrideType || F.type) {
                    case 'mousemove':
                      ;((G = 32),
                        F.buttons === void 0
                          ? ((q = 3), F.button !== void 0 && (q = F.button < 3 ? F.button : 3))
                          : (q = 1 & F.buttons ? 0 : 4 & F.buttons ? 1 : 2 & F.buttons ? 2 : 3))
                      break
                    case 'mouseup':
                ...
                ;(this.register(
                  this.coreMouseService.onProtocolChange((F) => {
                    ;(F
                      ...
                      8 & F
                        ...
                        : (R.removeEventListener('mousemove', A.mousemove), (A.mousemove = null)),
                      16 & F
                        ? A.wheel ||
                          (R.addEventListener('wheel', N.wheel, { passive: !1 }),
                          (A.wheel = N.wheel))
                        : (R.removeEventListener('wheel', A.wheel), (A.wheel = null)),
                      2 & F
                        ? A.mouseup ||
                          (R.addEventListener('mouseup', N.mouseup), (A.mouseup = N.mouseup))
                        : (this._document.removeEventListener('mouseup', A.mouseup),
                  ...
                  this.register(
                    (0, _.addDisposableDomListener)(R, 'mousedown', (F) => {
                      if (
                        (F.preventDefault(),
                        this.focus(),
                        this.coreMouseService.areMouseEventsActive &&
                        ...
                        return (
                          ...
                          A.mousedrag && this._document.addEventListener('mousemove', A.mousedrag),
                          this.cancel(F)
                        )
                    })
                  ),
                        ...
                        if (!A.wheel) {
                          if (!this.buffer.hasScrollback) {
                            ...
                            const q =
                              ...
                              (F.deltaY < 0 ? 'A' : 'B')
                            let G = ''
                            for (let ie = 0; ie < Math.abs(j); ie++) G += q
                            return (this.coreService.triggerDataEvent(G, !0), this.cancel(F, !0))
                          }
              ...
              refresh(S, R) {
                var B
                ;(B = this._renderService) === null || B === void 0 || B.refreshRows(S, R)
              }
              updateCursorStyle(S) {
                var R
                !((R = this._selectionService) === null || R === void 0) && R.shouldColumnSelect(S)
              ...
              scrollLines(S, R, B = 0) {
                var A
                B === 1
                  ? (super.scrollLines(S, R, B), this.refresh(0, this.rows - 1))
                  : (A = this.viewport) === null || A === void 0 || A.scrollLines(S)
              }
              paste(S) {
              ...
              selectLines(S, R) {
                var B
                ;(B = this._selectionService) === null || B === void 0 || B.selectLines(S, R)
              }
              _keyDown(S) {
                if (
                  ((this._keyDownHandled = !1),
                  (this._keyDownSeen = !0),
                  this._customKeyEventHandler && this._customKeyEventHandler(S) === !1)
                )
                  return !1
                  ...
                  !!this._isThirdLevelShift(this.browser, S) ||
                    ...
                    !B.key ||
                      ...
                      (this._unprocessedDeadKey
                        ...
                        : ((B.key !== M.C0.ETX && B.key !== M.C0.CR) || (this.textarea.value = ''),
                          this._onKey.fire({ key: B.key, domEvent: S }),
                          this._showCursor(),
                          this.coreService.triggerDataEvent(B.key, !0),
                          !this.optionsService.rawOptions.screenReaderMode || S.altKey || S.ctrlKey
                            ? this.cancel(S, !0)
              ...
              _isThirdLevelShift(S, R) {
                ...
                return R.type === 'keypress' ? B : B && (!R.keyCode || R.keyCode > 47)
              }
              _keyUp(S) {
                ;((this._keyDownSeen = !1),
                  (this._customKeyEventHandler && this._customKeyEventHandler(S) === !1) ||
              ...
              _afterResize(S, R) {
                var B, A
                ;((B = this._charSizeService) === null || B === void 0 || B.measure(),
                  (A = this.viewport) === null || A === void 0 || A.syncScrollArea(!0))
              }
              clear() {
                var S
                if (this.buffer.ybase !== 0 || this.buffer.y !== 0) {
                  ...
                  for (let R = 1; R < this.rows; R++)
                    this.buffer.lines.push(this.buffer.getBlankLine(O.DEFAULT_ATTR_DATA))
                  ;(this._onScroll.fire({ position: this.buffer.ydisp, source: 0 }),
                    (S = this.viewport) === null || S === void 0 || S.reset(),
                    this.refresh(0, this.rows - 1))
                }
              }
              reset() {
                ...
                ;(this._setup(),
                  super.reset(),
                  (S = this._selectionService) === null || S === void 0 || S.reset(),
                  this._decorationService.reset(),
                  (R = this.viewport) === null || R === void 0 || R.reset(),
              ...
              _reportFocus() {
                var S
                !((S = this.element) === null || S === void 0) && S.classList.contains('focus')
                  ? this.coreService.triggerDataEvent(M.C0.ESC + '[I')
                  : this.coreService.triggerDataEvent(M.C0.ESC + '[O')
              }
                ...
                if (this._renderService)
                  switch (S) {
                    case P.WindowsOptionsReportType.GET_WIN_SIZE_PIXELS:
                      const R = this._renderService.dimensions.css.canvas.width.toFixed(0),
                        B = this._renderService.dimensions.css.canvas.height.toFixed(0)
                      this.coreService.triggerDataEvent(`${M.C0.ESC}[4;${B};${R}t`)
                      break
                    case P.WindowsOptionsReportType.GET_CELL_SIZE_PIXELS:
                      const A = this._renderService.dimensions.css.cell.width.toFixed(0),
                        N = this._renderService.dimensions.css.cell.height.toFixed(0)
                      this.coreService.triggerDataEvent(`${M.C0.ESC}[6;${N};${A}t`)
                  }
              }
              cancel(S, R) {
          ...
          1680: function (I, r, a) {
            var c =
                ...
                function (s, t, i, o) {
                  var l,
                    v = arguments.length,
                    m = v < 3 ? t : o === null ? (o = Object.getOwnPropertyDescriptor(t, i)) : o
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    m = Reflect.decorate(s, t, i, o)
                  else
                    for (var h = s.length - 1; h >= 0; h--)
                      (l = s[h]) && (m = (v < 3 ? l(m) : v > 3 ? l(t, i, m) : l(t, i)) || m)
            ...
            let e = (r.Viewport = class extends p.Disposable {
              constructor(s, t, i, o, l, v, m, h) {
                ;(super(),
                  ...
                  this.register(
                    this._renderService.onDimensionsChange((g) => (this._renderDimensions = g))
                  ),
                  this._handleThemeChange(h.colors),
                  this.register(h.onChangeColors((g) => this._handleThemeChange(g))),
                  this.register(
              ...
              getBufferElements(s, t) {
                ...
                for (let g = s; g < m; g++) {
                  const b = h.get(g)
                  if (!b) continue
                  const L = (i = h.get(g + 1)) === null || i === void 0 ? void 0 : i.isWrapped
                  if (((l += b.translateToString(!L)), !L || g === h.length - 1)) {
              ...
              getLinesScrolled(s) {
                ...
                return (
                  s.deltaMode === WheelEvent.DOM_DELTA_PIXEL
                    ...
                    : s.deltaMode === WheelEvent.DOM_DELTA_PAGE && (t *= this._bufferService.rows),
                  t
                )
              }
              ...
              handleTouchMove(s) {
                ...
                return (
                  (this._lastTouchY = s.touches[0].pageY),
                  t !== 0 && ((this._viewportElement.scrollTop += t), this._bubbleScroll(s, t))
                )
              }
            })
            r.Viewport = e = c(
            ...
            let u = (r.BufferDecorationRenderer = class extends f.Disposable {
              constructor(e, s, t, i) {
                ;(super(),
                  ...
                  this.register(
                    this._decorationService.onDecorationRemoved((o) => this._removeDecoration(o))
                  ),
                  this.register(
                    (0, f.toDisposable)(() => {
              ...
              _createElement(e) {
                ...
                ;(i.classList.add('xterm-decoration'),
                  i.classList.toggle(
                    ...
                    ((s = e?.options) === null || s === void 0 ? void 0 : s.layer) === 'top'
                  ),
                ...
                return (
                  o && o > this._bufferService.cols && (i.style.display = 'none'),
              ...
              _refreshStyle(e) {
                ...
                if (s < 0 || s >= this._bufferService.rows)
                  ...
                  ;(t ||
                    ...
                    (t.style.top = s * this._renderService.dimensions.css.cell.height + 'px'),
                    (t.style.display = this._altBufferIsActive ? 'none' : 'block'),
              ...
              _removeDecoration(e) {
                var s
                ;((s = this._decorationElements.get(e)) === null || s === void 0 || s.remove(),
                  this._decorationElements.delete(e),
                  e.dispose())
              }
            })
            r.BufferDecorationRenderer = u = c(
              [_(1, p.IBufferService), _(2, p.IDecorationService), _(3, d.IRenderService)],
              u
            )
          },
          5871: (I, r) => {
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              ...
              (r.ColorZoneStore = class {
                ...
                addDecoration(a) {
                  if (a.options.overviewRulerOptions) {
                    for (const c of this._zones)
                      if (
                        c.color === a.options.overviewRulerOptions.color &&
                        c.position === a.options.overviewRulerOptions.position
                      ) {
                        ...
                        if (
                          ...
                          return void this._addLineToZone(c, a.marker.line)
                      }
                ...
                _lineAdjacentToZone(a, c, _) {
                  return (
                    c >= a.startBufferLine - this._linePadding[_ || 'full'] &&
          ...
          5744: function (I, r, a) {
            var c =
                ...
                function (o, l, v, m) {
                  var h,
                    g = arguments.length,
                    b = g < 3 ? l : m === null ? (m = Object.getOwnPropertyDescriptor(l, v)) : m
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    b = Reflect.decorate(o, l, v, m)
                  else
                    for (var L = o.length - 1; L >= 0; L--)
                      (h = o[L]) && (b = (g < 3 ? h(b) : g > 3 ? h(l, v, b) : h(l, v)) || b)
            ...
            let i = (r.OverviewRulerRenderer = class extends p.Disposable {
              get _width() {
              ...
              _registerDimensionChangeListeners() {
                ;(this.register(
                  ...
                  this.register(
                    (0, d.addDisposableDomListener)(this._coreBrowseService.window, 'resize', () =>
                      this._queueRefresh(!0)
                    )
                  ),
                  this._queueRefresh(!0))
              ...
              _refreshDrawHeightConstants() {
                ...
                const o = this._canvas.height / this._bufferService.buffer.lines.length,
                  l = Math.round(Math.max(Math.min(o, 12), 6) * this._coreBrowseService.dpr)
                  ...
                  this._ctx.fillRect(
                    ...
                    Math.round(
                      (this._canvas.height - 1) *
                        (o.startBufferLine / this._bufferService.buffers.active.lines.length) -
                        e[o.position || 'full'] / 2
                    ),
                    s[o.position || 'full'],
                    Math.round(
              ...
              _queueRefresh(o, l) {
                ;((this._shouldUpdateDimensions = o || this._shouldUpdateDimensions),
                  (this._shouldUpdateAnchor = l || this._shouldUpdateAnchor),
                  this._animationFrame === void 0 &&
          ...
          2950: function (I, r, a) {
            ...
            let p = (r.CompositionHelper = class {
              ...
              _finalizeComposition(u) {
                if (
                  (this._compositionView.classList.remove('active'), (this._isComposing = !1), u)
                ) {
                  const e = {
                  ...
                  if (this._bufferService.buffer.isCursorInViewport) {
                    const e = Math.min(this._bufferService.buffer.x, this._bufferService.cols - 1),
                      ...
                      t =
                        ...
                        this._renderService.dimensions.css.cell.height,
                      i = e * this._renderService.dimensions.css.cell.width
          ...
          9504: (I, r, a) => {
              ...
              for (; v !== t || m !== i; )
                ((v += o ? 1 : -1),
                  o && v > l.cols - 1
                    ...
                    : !o &&
                      v < 0 &&
                      ((h += l.buffer.translateBufferLineToString(m, !1, 0, e + 1)),
                      (v = l.cols - 1),
                      (e = v),
                      m--))
            ...
            r.moveToCellSequence = function (e, s, t, i) {
                ...
                return (
                  (function (h, g, b, L, y, k) {
                    return _(g, L, y, k).length === 0
                      ? ''
                      : u(f(h, g, h, g - n(g, y), !1, y).length, p('D', k))
                  })(o, l, 0, s, t, i) +
                  _(l, s, t, i) +
                  (function (h, g, b, L, y, k) {
                    let x
                    ...
                    const T = L,
                      O = (function (M, C, w, E, D, P) {
                        let H
                        return (
                          (H = _(w, E, D, P).length > 0 ? E - n(E, D) : C),
                          (M < w && H <= E) || (M >= w && H < E) ? 'C' : 'D'
                        )
                      })(h, g, b, L, y, k)
              ...
              let v
              if (l === s) return ((v = o > e ? 'D' : 'C'), u(Math.abs(o - e), p(v, i)))
              v = l > s ? 'D' : 'C'
          ...
          1296: function (I, r, a) {
            var c =
                ...
                function (y, k, x, T) {
                  var O,
                    M = arguments.length,
                    C = M < 3 ? k : T === null ? (T = Object.getOwnPropertyDescriptor(k, x)) : T
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    C = Reflect.decorate(y, k, x, T)
                  else
                    for (var w = y.length - 1; w >= 0; w--)
                      (O = y[w]) && (C = (M < 3 ? O(C) : M > 3 ? O(k, x, C) : O(k, x)) || C)
              ...
              L = (r.DomRenderer = class extends t.Disposable {
                constructor(y, k, x, T, O, M, C, w, E, D) {
                  ;(super(),
                    ...
                    this.register(this._themeService.onChangeColors((P) => this._injectCss(P))),
                    this._injectCss(this._themeService.colors),
                    (this._rowFactory = O.createInstance(n.DomRendererRowFactory, document)),
                    this._element.classList.add(o + this._terminalClass),
                    this._screenElement.appendChild(this._rowContainer),
                    this._screenElement.appendChild(this._selectionContainer),
                    this.register(
                      this._linkifier2.onShowLinkUnderline((P) => this._handleLinkHover(P))
                    ),
                    this.register(
                      this._linkifier2.onHideLinkUnderline((P) => this._handleLinkLeave(P))
                    ),
                    this.register(
                      (0, t.toDisposable)(() => {
                        ;(this._element.classList.remove(o + this._terminalClass),
                ...
                _updateDimensions() {
                  ...
                  ;((this.dimensions.device.char.width = this._charSizeService.width * y),
                ...
                handleSelectionChanged(y, k, x) {
                  ...
                  if (x) {
                    const E = y[0] > k[0]
                    w.appendChild(
                      this._createSelectionElement(M, E ? k[0] : y[0], E ? y[0] : k[0], C - M + 1)
                    )
                  } else {
                    const E = T === M ? y[0] : 0,
                    ...
                    if (
                      (w.appendChild(
                        this._createSelectionElement(M + 1, 0, this._bufferService.cols, P)
                      ),
                      M !== C)
                    ) {
                ...
                _createSelectionElement(y, k, x, T = 1) {
                  ...
                  return (
                    (O.style.height = T * this.dimensions.css.cell.height + 'px'),
                    (O.style.top = y * this.dimensions.css.cell.height + 'px'),
                    (O.style.left = k * this.dimensions.css.cell.width + 'px'),
                    (O.style.width = this.dimensions.css.cell.width * (x - k) + 'px'),
                    O
                  )
                }
                handleCursorMove() {}
          ...
          3787: function (I, r, a) {
            var c =
                ...
                function (v, m, h, g) {
                  var b,
                    L = arguments.length,
                    y = L < 3 ? m : g === null ? (g = Object.getOwnPropertyDescriptor(m, h)) : g
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    y = Reflect.decorate(v, m, h, g)
                  else
                    for (var k = v.length - 1; k >= 0; k--)
                      (b = v[k]) && (y = (L < 3 ? b(y) : L > 3 ? b(m, h, y) : b(m, h)) || y)
            ...
            let o = (r.DomRendererRowFactory = class {
              ...
              createRow(v, m, h, g, b, L, y, k, x, T, O) {
                ...
                for (let j = 0; j < D; j++) {
                  ...
                  const re = this._isCellInSelection(j, m),
                    ...
                    de = F && j >= T && j <= O
                  let ue = !1
                  this._decorationService.forEachDecorationAtCell(j, m, void 0, (K) => {
                    ue = !0
                  })
                  let he = $.getChars() || d.WHITESPACE_CELL_CHAR
                  if (
                    (he === ' ' && ($.isUnderline() || $.isOverline()) && (he = ' '),
                    ...
                    if (
                      P &&
                      ((re && B) || (!re && !B && $.bg === U)) &&
                      ((re && B && w.selectionForeground) || $.fg === W) &&
                      $.extended.ext === z &&
                      de === S &&
                      A === R &&
                      !ce &&
                  ...
                  if (
                    ...
                    if ((N.push('xterm-cursor'), this._coreBrowserService.isFocused))
                  ...
                  if (
                    ...
                    $.isUnderline() &&
                      (N.push(`xterm-underline-${$.extended.underlineStyle}`),
                      H === ' ' && (H = ' '),
                  ...
                  ;($.isOverline() && (N.push('xterm-overline'), H === ' ' && (H = ' ')),
                  ...
                  switch (
                    (this._decorationService.forEachDecorationAtCell(j, m, void 0, (K) => {
                      ;(K.options.layer !== 'top' && ae) ||
                        (K.backgroundColorRGB &&
                          ((oe = 50331648),
                          (Y = (K.backgroundColorRGB.rgba >> 8) & 16777215),
                          (Z = K.backgroundColorRGB)),
                        K.foregroundColorRGB &&
                          ((ne = 50331648),
                          (X = (K.foregroundColorRGB.rgba >> 8) & 16777215),
                    ...
                    !ae &&
                      ...
                      w.selectionForeground &&
                        ((ne = 50331648),
                        (X = (w.selectionForeground.rgba >> 8) & 16777215),
                    ...
                    case 33554432:
                      ...
                      break
                    case 50331648:
                      ;((Q = u.rgba.toColor(Y >> 16, (Y >> 8) & 255, 255 & Y)),
                        this._addStyle(E, `background-color:#${l((Y >>> 0).toString(16), '0', 6)}`))
                      break
                    default:
                      _e
                        ? ((Q = w.foreground), N.push(`xterm-bg-${n.INVERTED_DEFAULT_COLOR}`))
                        : (Q = w.background)
                  }
                  switch ((Z || ($.isDim() && (Z = u.color.multiplyOpacity(Q, 0.5))), ne)) {
                    case 16777216:
                    case 33554432:
                      ;($.isBold() &&
                        X < 8 &&
                        this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                        (X += 8),
                        this._applyMinimumContrast(E, Q, w.ansi[X], $, Z, void 0) ||
                          N.push(`xterm-fg-${X}`))
                      break
                    case 50331648:
                      const K = u.rgba.toColor((X >> 16) & 255, (X >> 8) & 255, 255 & X)
                      this._applyMinimumContrast(E, Q, K, $, Z, fe) ||
                        this._addStyle(E, `color:#${l(X.toString(16), '0', 6)}`)
                      break
                    default:
                      this._applyMinimumContrast(E, Q, w.foreground, $, Z, void 0) ||
                        (_e && N.push(`xterm-fg-${n.INVERTED_DEFAULT_COLOR}`))
                  }
                  ;(N.length && ((E.className = N.join(' ')), (N.length = 0)),
                    ce || G || ue ? (E.textContent = H) : P++,
                    A !== this.defaultSpacing && (E.style.letterSpacing = `${A}px`),
                    M.push(E),
                    (j = ie))
                }
              ...
              _applyMinimumContrast(v, m, h, g, b, L) {
                ...
                if ((b || L || (k = y.getColor(m.rgba, h.rgba)), k === void 0)) {
                  const x =
                    this._optionsService.rawOptions.minimumContrastRatio / (g.isDim() ? 2 : 1)
          ...
          2550: (I, r) => {
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              ...
              (r.WidthCache = class {
                ...
                get(a, c, _) {
                  let n = 0
                  if (!c && !_ && a.length === 1 && (n = a.charCodeAt(0)) < 256)
          ...
          2223: (I, r, a) => {
            ...
            ;((r.INVERTED_DEFAULT_COLOR = 257),
              (r.DIM_OPACITY = 0.5),
              (r.TEXT_BASELINE = c.isFirefox || c.isLegacyEdge ? 'bottom' : 'ideographic'))
          },
          6171: (I, r) => {
            function a(c) {
                    ...
                    if (!this.selectionEnd || this.areSelectionValuesReversed()) {
                      ...
                      return a > this._bufferService.cols
                        ? a % this._bufferService.cols == 0
                          ? [
                              this._bufferService.cols,
                              this.selectionStart[1] + Math.floor(a / this._bufferService.cols) - 1
                            ]
                          : [
            ...
            let p = (r.CharSizeService = class extends f.Disposable {
              ...
              constructor(e, s, t) {
                ;(super(),
                  ...
                  (this._measureStrategy = new u(e, s, this._optionsService)),
                  this.register(
            ...
            let e = (r.CharacterJoinerService = class ge {
              ...
              getJoinedCharacters(t) {
                ...
                for (let L = 0; L < i.getTrimmedLength(); L++)
                  if ((i.loadCell(L, this._workCell), this._workCell.getWidth() !== 0)) {
                    if (this._workCell.fg !== g || this._workCell.bg !== b) {
                      if (L - v > 1) {
                        const y = this._getJoinedRanges(l, h, m, i, v)
                        for (let k = 0; k < y.length; k++) o.push(y[k])
                      }
                      ;((v = L), (h = m), (g = this._workCell.fg), (b = this._workCell.bg))
                    }
                ...
                if (h) {
                  for (let g = o; g < this._bufferService.cols; g++) {
                    const b = i.getWidth(g),
                      L = i.getString(g).length || d.WHITESPACE_CELL_CHAR.length
                    if (b !== 0) {
              ...
              static _mergeRanges(t, i) {
                ...
                for (let l = 0; l < t.length; l++) {
                  ...
                  if (o) {
                    ...
                    if (i[1] <= v[1])
                      return ((t[l - 1][1] = Math.max(i[1], v[1])), t.splice(l, 1), t)
                    ;(t.splice(l, 1), l--)
                  } else {
          ...
          8934: function (I, r, a) {
            var c =
                ...
                function (p, u, e, s) {
                  var t,
                    i = arguments.length,
                    o = i < 3 ? u : s === null ? (s = Object.getOwnPropertyDescriptor(u, e)) : s
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    o = Reflect.decorate(p, u, e, s)
                  else
                    for (var l = p.length - 1; l >= 0; l--)
                      (t = p[l]) && (o = (i < 3 ? t(o) : i > 3 ? t(u, e, o) : t(u, e)) || o)
            ...
            let i = (r.RenderService = class extends e.Disposable {
              ...
              constructor(o, l, v, m, h, g, b, L) {
                if (
                  ...
                  (this._rowCount = o),
                  (this._charSizeService = m),
                  (this._renderer = this.register(new e.MutableDisposable())),
                  ...
                  (this._renderDebouncer = new d.RenderDebouncer(b.window, (y, k) =>
                    this._renderRows(y, k)
                  )),
                  this.register(this._renderDebouncer),
                  (this._screenDprMonitor = new f.ScreenDprMonitor(b.window)),
                  ...
                  this.register(
                    g.buffers.onBufferActivate(() => {
                      var y
                      return (y = this._renderer.value) === null || y === void 0
                        ? void 0
                        : y.clear()
                    })
                  ),
                  this.register(v.onOptionChange(() => this._handleOptionsChanged())),
                  this.register(
                    this._charSizeService.onCharSizeChange(() => this.handleCharSizeChanged())
                  ),
                  this.register(h.onDecorationRegistered(() => this._fullRefresh())),
                  this.register(h.onDecorationRemoved(() => this._fullRefresh())),
                  this.register(
                  ...
                  this.register(
                    v.onMultipleOptionChange(['cursorBlink', 'cursorStyle'], () =>
                      this.refreshRows(g.buffer.y, g.buffer.y, !0)
                    )
                  ),
                  this.register(
                    (0, n.addDisposableDomListener)(b.window, 'resize', () =>
                      this.handleDevicePixelRatioChange()
                    )
                  ),
                  this.register(L.onChangeColors(() => this._fullRefresh())),
                  'IntersectionObserver' in b.window)
                ) {
                  const y = new b.window.IntersectionObserver(
                    (k) => this._handleIntersectionChange(k[k.length - 1]),
                    { threshold: 0 }
                  )
              ...
              _handleIntersectionChange(o) {
                ;((this._isPaused =
                  o.isIntersecting === void 0 ? o.intersectionRatio === 0 : !o.isIntersecting),
                  this._isPaused ||
                    this._charSizeService.hasValidSize ||
                    this._charSizeService.measure(),
                  !this._isPaused &&
              ...
              _renderRows(o, l) {
                this._renderer.value &&
                  ...
                  this._isNextRenderRedrawOnly ||
                    this._onRenderedViewportChange.fire({ start: o, end: l }),
              ...
              setRenderer(o) {
                ;((this._renderer.value = o),
                  this._renderer.value.onRequestRedraw((l) => this.refreshRows(l.start, l.end, !0)),
              ...
              clearTextureAtlas() {
                var o, l
                this._renderer.value &&
                  ((l = (o = this._renderer.value).clearTextureAtlas) === null ||
                    l === void 0 ||
                    l.call(o),
                  this._fullRefresh())
              }
              ...
              handleResize(o, l) {
                this._renderer.value &&
                  (this._isPaused
                    ? this._pausedResizeTask.set(() => this._renderer.value.handleResize(o, l))
          ...
          9312: function (I, r, a) {
            var c =
                ...
                function (h, g, b, L) {
                  var y,
                    k = arguments.length,
                    x = k < 3 ? g : L === null ? (L = Object.getOwnPropertyDescriptor(g, b)) : L
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    x = Reflect.decorate(h, g, b, L)
                  else
                    for (var T = h.length - 1; T >= 0; T--)
                      (y = h[T]) && (x = (k < 3 ? y(x) : k > 3 ? y(g, b, x) : y(g, b)) || x)
            ...
            let m = (r.SelectionService = class extends e.Disposable {
              constructor(h, g, b, L, y, k, x, T, O) {
                ;(super(),
                  ...
                  (this._onLinuxMouseSelection = this.register(new u.EventEmitter())),
                  (this.onLinuxMouseSelection = this._onLinuxMouseSelection.event),
                  (this._onRedrawRequest = this.register(new u.EventEmitter())),
                  (this.onRequestRedraw = this._onRedrawRequest.event),
                  (this._onSelectionChange = this.register(new u.EventEmitter())),
                  (this.onSelectionChange = this._onSelectionChange.event),
                  (this._onRequestScrollLines = this.register(new u.EventEmitter())),
                  (this.onRequestScrollLines = this._onRequestScrollLines.event),
                  (this._mouseMoveListener = (M) => this._handleMouseMove(M)),
                  (this._mouseUpListener = (M) => this._handleMouseUp(M)),
                  this._coreService.onUserInput(() => {
                    this.hasSelection && this.clearSelection()
                  }),
                  (this._trimListener = this._bufferService.buffer.lines.onTrim((M) =>
                    this._handleTrim(M)
                  )),
                  this.register(
...
`
              ...
              _isClickInSelection(h) {
                ...
                return !!(b && L && g) && this._areCoordsInSelection(g, b, L)
              }
              isCellInSelection(h, g) {
                const b = this._model.finalSelectionStart,
                  L = this._model.finalSelectionEnd
                return !(!b || !L) && this._areCoordsInSelection([h, g], b, L)
              }
              _areCoordsInSelection(h, g, b) {
                return (
                  (h[1] > g[1] && h[1] < b[1]) ||
                  (g[1] === b[1] && h[1] === g[1] && h[0] >= g[0] && h[0] < b[0]) ||
              ...
              _selectWordAtCursor(h, g) {
                ...
                const y =
                  (L =
                    (b = this._linkifier.currentLink) === null || b === void 0
                      ? void 0
                ...
                if (y)
                  return (
                    ...
                    (this._model.selectionStartLength = (0, t.getRangeLength)(
                      y,
                      this._bufferService.cols
                    )),
              ...
              selectLines(h, g) {
                ;(this._model.clearSelection(),
                  (h = Math.max(h, 0)),
                  (g = Math.min(g, this._bufferService.buffer.lines.length - 1)),
                  (this._model.selectionStart = [0, h]),
                  (this._model.selectionEnd = [this._bufferService.cols, g]),
                  this.refresh(),
                  this._onSelectionChange.fire())
              }
              _handleTrim(h) {
              ...
              shouldForceSelection(h) {
                return s.isMac
                  ? h.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection
                  : h.shiftKey
              }
              handleMouseDown(h) {
                if (
                  ((this._mouseDownTimeStamp = h.timeStamp),
                  (h.button !== 2 || !this.hasSelection) && h.button === 0)
                ) {
                  if (!this._enabled) {
              ...
              _handleIncrementalClick(h) {
                this._model.selectionStart &&
                  (this._model.selectionEnd = this._getMouseBufferCoords(h))
              }
              _handleSingleClick(h) {
                if (
                  ((this._model.selectionStartLength = 0),
                  (this._model.isSelectAllActive = !1),
                  (this._activeSelectionMode = this.shouldColumnSelect(h) ? 3 : 0),
                  (this._model.selectionStart = this._getMouseBufferCoords(h)),
                  !this._model.selectionStart)
                )
                  return
                this._model.selectionEnd = void 0
              ...
              _handleMouseMove(h) {
                ...
                ;(this._activeSelectionMode === 2
                  ...
                  (this._dragScrollAmount = this._getMouseEventScrollAmount(h)),
              ...
              _fireEventIfSelectionChanged() {
                ...
                b
                  ...
                  : this._oldHasSelection && this._fireOnSelectionChange(h, g, b)
              }
              ...
              _handleBufferActivate(h) {
                ;(this.clearSelection(),
                  ...
                  (this._trimListener = h.activeBuffer.lines.onTrim((g) => this._handleTrim(g))))
              }
              _convertViewportColToCharacterIndex(h, g) {
                let b = g
                for (let L = 0; g >= L; L++) {
                  const y = h.loadCell(L, this._workCell).getChars().length
                  this._workCell.getWidth() === 0 ? b-- : y > 1 && g !== L && (b += y - 1)
                }
                return b
              }
              setSelection(h, g, b) {
              ...
              _getWordAt(h, g, b = !0, L = !0) {
                ...
                if (x.charAt(T) === ' ') {
                  ...
                  let U = h[0],
                    W = h[0]
                  ;(k.getWidth(U) === 0 && (C++, U--), k.getWidth(W) === 2 && (w++, W++))
                  const z = k.getString(W).length
                  for (
                    z > 1 && ((D += z - 1), (O += z - 1));
                    U > 0 && T > 0 && !this._isCharWordSeparator(k.loadCell(U - 1, this._workCell));
                  ...
                  for (
                    ...
                    W < k.length &&
                    O + 1 < x.length &&
                    !this._isCharWordSeparator(k.loadCell(W + 1, this._workCell));
                ...
                O++
                let P = T + M - C + E,
                  H = Math.min(this._bufferService.cols, O - T + C + w - E - D)
              ...
              _selectToWordAt(h) {
                ...
                if (g) {
                  let b = h[1]
                  for (; g.start < 0; ) ((g.start += this._bufferService.cols), b--)
                  if (!this._model.areSelectionValuesReversed())
                    for (; g.start + g.length > this._bufferService.cols; )
                      ((g.length -= this._bufferService.cols), b++)
                  this._model.selectionEnd = [
                    this._model.areSelectionValuesReversed() ? g.start : g.start + g.length,
                    b
                  ]
                }
              }
              _isCharWordSeparator(h) {
                return (
                  h.getWidth() !== 0 &&
                  this._optionsService.rawOptions.wordSeparator.indexOf(h.getChars()) >= 0
                )
              }
              _selectLineAt(h) {
                const g = this._bufferService.buffer.getWrappedRangeForLine(h),
                  b = {
                    start: { x: 0, y: g.first },
            ...
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              (r.IThemeService =
                ...
                r.ICharSizeService =
                  void 0))
            const c = a(8343)
            ;((r.ICharSizeService = (0, c.createDecorator)('CharSizeService')),
              (r.ICoreBrowserService = (0, c.createDecorator)('CoreBrowserService')),
              (r.IMouseService = (0, c.createDecorator)('MouseService')),
              (r.IRenderService = (0, c.createDecorator)('RenderService')),
              (r.ISelectionService = (0, c.createDecorator)('SelectionService')),
              (r.ICharacterJoinerService = (0, c.createDecorator)('CharacterJoinerService')),
          ...
          6731: function (I, r, a) {
            var c =
                ...
                function (m, h, g, b) {
                  var L,
                    y = arguments.length,
                    k = y < 3 ? h : b === null ? (b = Object.getOwnPropertyDescriptor(h, g)) : b
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    k = Reflect.decorate(m, h, g, b)
                  else
                    for (var x = m.length - 1; x >= 0; x--)
                      (L = m[x]) && (k = (y < 3 ? L(k) : y > 3 ? L(h, g, k) : L(h, g)) || k)
            ...
            let l = (r.ThemeService = class extends p.Disposable {
              ...
              _setTheme(m = {}) {
                ...
                if (
                  ...
                  (h.selectionBackgroundTransparent = v(m.selectionBackground, o)),
                  ...
                  (h.selectionForeground = m.selectionForeground
                    ...
                    : void 0),
                  h.selectionForeground === d.NULL_COLOR && (h.selectionForeground = void 0),
                  d.color.isOpaque(h.selectionBackgroundTransparent) &&
                    (h.selectionBackgroundTransparent = d.color.opacity(
                      h.selectionBackgroundTransparent,
                      0.3
                    )),
                  d.color.isOpaque(h.selectionInactiveBackgroundTransparent) &&
                    (h.selectionInactiveBackgroundTransparent = d.color.opacity(
                      h.selectionInactiveBackgroundTransparent,
                      0.3
                    )),
                  ...
                  (h.ansi[8] = v(m.brightBlack, r.DEFAULT_ANSI_COLORS[8])),
                  (h.ansi[9] = v(m.brightRed, r.DEFAULT_ANSI_COLORS[9])),
                  (h.ansi[10] = v(m.brightGreen, r.DEFAULT_ANSI_COLORS[10])),
                  (h.ansi[11] = v(m.brightYellow, r.DEFAULT_ANSI_COLORS[11])),
                  (h.ansi[12] = v(m.brightBlue, r.DEFAULT_ANSI_COLORS[12])),
                  (h.ansi[13] = v(m.brightMagenta, r.DEFAULT_ANSI_COLORS[13])),
                  (h.ansi[14] = v(m.brightCyan, r.DEFAULT_ANSI_COLORS[14])),
                  (h.ansi[15] = v(m.brightWhite, r.DEFAULT_ANSI_COLORS[15])),
                  m.extendedAnsi)
                ) {
                  const g = Math.min(h.ansi.length - 16, m.extendedAnsi.length)
                  for (let b = 0; b < g; b++)
                    h.ansi[b + 16] = v(m.extendedAnsi[b], r.DEFAULT_ANSI_COLORS[b + 16])
                }
                ;(this._contrastCache.clear(),
              ...
              _restoreColor(m) {
                if (m !== void 0)
                  ...
                  for (let h = 0; h < this._restoreColors.ansi.length; ++h)
            ...
            class n extends _.Disposable {
              ...
              splice(f, p, ...u) {
                if (p) {
                  for (let e = f; e < this._length - p; e++)
                    this._array[this._getCyclicIndex(e)] = this._array[this._getCyclicIndex(e + p)]
                ...
                if (
                  (u.length && this.onInsertEmitter.fire({ index: f, amount: u.length }),
              ...
              shiftElements(f, p, u) {
                if (!(p <= 0)) {
                  ...
                  if (u > 0) {
                    for (let s = p - 1; s >= 0; s--) this.set(f + s + u, this.get(f + s))
              ...
              (function (l) {
                function v(m, h) {
                  return (
                    ...
                    { css: p.toCss(_, n, d, f), rgba: p.toRgba(_, n, d, f) }
                  )
                }
                ...
                l.toColor = function (h) {
                  ...
                  if (g)
                    return (
                      ...
                      (n = parseInt(g[2])),
                      (d = parseInt(g[3])),
                      (f = Math.round(255 * (g[5] === void 0 ? 1 : parseFloat(g[5])))),
                      t.toColor(_, n, d, f)
                    )
                  if (!v || !m) throw new Error('css.toColor: Unsupported css format')
                  if (((v.fillStyle = m), (v.fillStyle = h), typeof v.fillStyle != 'string'))
              ...
              (function (l) {
                function v(m, h, g) {
                  const b = m / 255,
                    ...
                    y = g / 255
                  return (
                    0.2126 * (b <= 0.03928 ? b / 12.92 : Math.pow((b + 0.055) / 1.055, 2.4)) +
                    0.7152 * (L <= 0.03928 ? L / 12.92 : Math.pow((L + 0.055) / 1.055, 2.4)) +
              ...
              (function (l) {
                function v(h, g, b) {
                  ...
                  let x = (g >> 24) & 255,
                    T = (g >> 16) & 255,
                    O = (g >> 8) & 255,
                    M = o(s.relativeLuminance2(x, T, O), s.relativeLuminance2(L, y, k))
                  for (; M < b && (x > 0 || T > 0 || O > 0); )
                ...
                ;((l.ensureContrastRatio = function (h, g, b) {
                  ...
                  (l.toColor = function (h, g, b, L) {
                    return { css: p.toCss(h, g, b, L), rgba: p.toRgba(h, g, b, L) }
                  }))
              })(t || (r.rgba = t = {})),
              (r.toPaddedHex = i),
              (r.contrastRatio = o))
          ...
          8969: (I, r, a) => {
            ...
            class g extends c.Disposable {
              get onScroll() {
                return (
                  this._onScrollApi ||
                    ((this._onScrollApi = this.register(new e.EventEmitter())),
              ...
              constructor(L) {
                ;(super(),
                  ...
                  (this._onLineFeed = this.register(new e.EventEmitter())),
                  (this.onLineFeed = this._onLineFeed.event),
                  (this._onResize = this.register(new e.EventEmitter())),
                  (this.onResize = this._onResize.event),
                  (this._onWriteParsed = this.register(new e.EventEmitter())),
                  ...
                  (this.optionsService = this.register(new p.OptionsService(L))),
                  this._instantiationService.setService(_.IOptionsService, this.optionsService),
                  (this._bufferService = this.register(
                    this._instantiationService.createInstance(f.BufferService)
                  )),
                  this._instantiationService.setService(_.IBufferService, this._bufferService),
                  ...
                  (this.coreService = this.register(
                    this._instantiationService.createInstance(u.CoreService)
                  )),
                  ...
                  this._instantiationService.setService(_.ICoreMouseService, this.coreMouseService),
                  (this.unicodeService = this.register(
                    this._instantiationService.createInstance(t.UnicodeService)
                  )),
                  this._instantiationService.setService(_.IUnicodeService, this.unicodeService),
                  (this._charsetService = this._instantiationService.createInstance(
                    i.CharsetService
                  )),
                  this._instantiationService.setService(_.ICharsetService, this._charsetService),
                  (this._oscLinkService = this._instantiationService.createInstance(
                    m.OscLinkService
                  )),
                  this._instantiationService.setService(_.IOscLinkService, this._oscLinkService),
                  ...
                  this.register(
                    (0, e.forwardEvent)(this._inputHandler.onLineFeed, this._onLineFeed)
                  ),
                  this.register(this._inputHandler),
                  this.register((0, e.forwardEvent)(this._bufferService.onResize, this._onResize)),
                  this.register((0, e.forwardEvent)(this.coreService.onData, this._onData)),
                  this.register((0, e.forwardEvent)(this.coreService.onBinary, this._onBinary)),
                  this.register(
                  ...
                  (this._writeBuffer = this.register(
                    new v.WriteBuffer((y, k) => this._inputHandler.parse(y, k))
                  )),
                  this.register(
                    (0, e.forwardEvent)(this._writeBuffer.onWriteParsed, this._onWriteParsed)
                  ))
              }
              write(L, y) {
              ...
              _handleWindowsPtyOptionChange() {
                ...
                ;(y && y.buildNumber !== void 0 && y.buildNumber !== void 0
                  ...
                  : this.optionsService.rawOptions.windowsMode && (L = !0),
                  L
              ...
              _enableWindowsWrappingHeuristics() {
                if (!this._windowsWrappingHeuristics.value) {
                  const L = []
                  ;(L.push(
                    this.onLineFeed(o.updateWindowsModeWrappedState.bind(null, this._bufferService))
                  ),
                    L.push(
                    ...
                    (this._windowsWrappingHeuristics.value = (0, c.toDisposable)(() => {
          ...
          5435: function (I, r, a) {
            var c =
                ...
                function (M, C, w, E) {
                  var D,
                    P = arguments.length,
                    H = P < 3 ? C : E === null ? (E = Object.getOwnPropertyDescriptor(C, w)) : E
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    H = Reflect.decorate(M, C, w, E)
                  else
                    for (var U = M.length - 1; U >= 0; U--)
                      (D = M[U]) && (H = (P < 3 ? D(H) : P > 3 ? D(C, w, H) : D(C, w)) || H)
            ...
            ;(function (M) {
              ;((M[(M.GET_WIN_SIZE_PIXELS = 0)] = 'GET_WIN_SIZE_PIXELS'),
                (M[(M.GET_CELL_SIZE_PIXELS = 1)] = 'GET_CELL_SIZE_PIXELS'))
            ...
            class x extends p.Disposable {
              ...
              constructor(C, w, E, D, P, H, U, W, z = new f.EscapeSequenceParser()) {
                ;(super(),
                  ...
                  this._parser.setPrintHandler((S, R, B) => this.print(S, R, B)),
                  this._parser.registerCsiHandler({ final: '@' }, (S) => this.insertChars(S)),
                  this._parser.registerCsiHandler({ intermediates: ' ', final: '@' }, (S) =>
                    this.scrollLeft(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'A' }, (S) => this.cursorUp(S)),
                  this._parser.registerCsiHandler({ intermediates: ' ', final: 'A' }, (S) =>
                    this.scrollRight(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'B' }, (S) => this.cursorDown(S)),
                  this._parser.registerCsiHandler({ final: 'C' }, (S) => this.cursorForward(S)),
                  this._parser.registerCsiHandler({ final: 'D' }, (S) => this.cursorBackward(S)),
                  this._parser.registerCsiHandler({ final: 'E' }, (S) => this.cursorNextLine(S)),
                  ...
                  this._parser.registerCsiHandler({ final: 'H' }, (S) => this.cursorPosition(S)),
                  this._parser.registerCsiHandler({ final: 'I' }, (S) => this.cursorForwardTab(S)),
                  this._parser.registerCsiHandler({ final: 'J' }, (S) =>
                    this.eraseInDisplay(S, !1)
                  ),
                  this._parser.registerCsiHandler({ prefix: '?', final: 'J' }, (S) =>
                    this.eraseInDisplay(S, !0)
                  ),
                  this._parser.registerCsiHandler({ final: 'K' }, (S) => this.eraseInLine(S, !1)),
                  this._parser.registerCsiHandler({ prefix: '?', final: 'K' }, (S) =>
                    this.eraseInLine(S, !0)
                  ),
                  this._parser.registerCsiHandler({ final: 'L' }, (S) => this.insertLines(S)),
                  this._parser.registerCsiHandler({ final: 'M' }, (S) => this.deleteLines(S)),
                  this._parser.registerCsiHandler({ final: 'P' }, (S) => this.deleteChars(S)),
                  this._parser.registerCsiHandler({ final: 'S' }, (S) => this.scrollUp(S)),
                  this._parser.registerCsiHandler({ final: 'T' }, (S) => this.scrollDown(S)),
                  this._parser.registerCsiHandler({ final: 'X' }, (S) => this.eraseChars(S)),
                  this._parser.registerCsiHandler({ final: 'Z' }, (S) => this.cursorBackwardTab(S)),
                  this._parser.registerCsiHandler({ final: '`' }, (S) => this.charPosAbsolute(S)),
                  this._parser.registerCsiHandler({ final: 'a' }, (S) => this.hPositionRelative(S)),
                  ...
                  this._parser.registerCsiHandler({ prefix: '>', final: 'c' }, (S) =>
                    this.sendDeviceAttributesSecondary(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'd' }, (S) => this.linePosAbsolute(S)),
                  this._parser.registerCsiHandler({ final: 'e' }, (S) => this.vPositionRelative(S)),
                  this._parser.registerCsiHandler({ final: 'f' }, (S) => this.hVPosition(S)),
                  this._parser.registerCsiHandler({ final: 'g' }, (S) => this.tabClear(S)),
                  this._parser.registerCsiHandler({ final: 'h' }, (S) => this.setMode(S)),
                  this._parser.registerCsiHandler({ prefix: '?', final: 'h' }, (S) =>
                    this.setModePrivate(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'l' }, (S) => this.resetMode(S)),
                  this._parser.registerCsiHandler({ prefix: '?', final: 'l' }, (S) =>
                    this.resetModePrivate(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'm' }, (S) => this.charAttributes(S)),
                  this._parser.registerCsiHandler({ final: 'n' }, (S) => this.deviceStatus(S)),
                  this._parser.registerCsiHandler({ prefix: '?', final: 'n' }, (S) =>
                    this.deviceStatusPrivate(S)
                  ),
                  this._parser.registerCsiHandler({ intermediates: '!', final: 'p' }, (S) =>
                    this.softReset(S)
                  ),
                  this._parser.registerCsiHandler({ intermediates: ' ', final: 'q' }, (S) =>
                    this.setCursorStyle(S)
                  ),
                  this._parser.registerCsiHandler({ final: 'r' }, (S) => this.setScrollRegion(S)),
                  this._parser.registerCsiHandler({ final: 's' }, (S) => this.saveCursor(S)),
                  this._parser.registerCsiHandler({ final: 't' }, (S) => this.windowOptions(S)),
                  this._parser.registerCsiHandler({ final: 'u' }, (S) => this.restoreCursor(S)),
                  this._parser.registerCsiHandler({ intermediates: "'", final: '}' }, (S) =>
                    this.insertColumns(S)
                  ),
                  this._parser.registerCsiHandler({ intermediates: "'", final: '~' }, (S) =>
                    this.deleteColumns(S)
                  ),
                  this._parser.registerCsiHandler({ intermediates: '"', final: 'q' }, (S) =>
                    this.selectProtected(S)
                  ),
                  this._parser.registerCsiHandler({ intermediates: '$', final: 'p' }, (S) =>
                    this.requestMode(S, !0)
                  ),
                  ...
                  this._parser.registerOscHandler(
                    0,
                    new v.OscHandler((S) => (this.setTitle(S), this.setIconName(S), !0))
                  ),
                  this._parser.registerOscHandler(1, new v.OscHandler((S) => this.setIconName(S))),
                  this._parser.registerOscHandler(2, new v.OscHandler((S) => this.setTitle(S))),
                  this._parser.registerOscHandler(
                    4,
                    new v.OscHandler((S) => this.setOrReportIndexedColor(S))
                  ),
                  this._parser.registerOscHandler(8, new v.OscHandler((S) => this.setHyperlink(S))),
                  this._parser.registerOscHandler(
                    10,
                  ...
                  this._parser.registerOscHandler(
                    12,
                    new v.OscHandler((S) => this.setOrReportCursorColor(S))
                  ),
                  this._parser.registerOscHandler(
                    104,
                ...
                for (const S in d.CHARSETS)
                  (this._parser.registerEscHandler({ intermediates: '(', final: S }, () =>
                ...
                ;(this._parser.registerEscHandler({ intermediates: '#', final: '8' }, () =>
                  ...
                  this._parser.setErrorHandler(
                    (S) => (this._logService.error('Parsing error: ', S), S)
                  ),
                  this._parser.registerDcsHandler(
                    { intermediates: '$', final: 'q' },
                    new m.DcsHandler((S, R) => this.requestStatusString(S, R))
                  ))
              }
              ...
              _logSlowResolvingAsync(C) {
                this._logService.logLevel <= l.LogLevelEnum.WARN &&
                  Promise.race([
                    C,
                    new Promise((w, E) => setTimeout(() => E('#SLOW_TIMEOUT'), 5e3))
                  ]).catch((w) => {
              ...
              parse(C, w) {
                ...
                if (U) {
                  if (
                    (E = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, w))
                  )
                ...
                if (
                  (this._logService.logLevel <= l.LogLevelEnum.DEBUG &&
                    this._logService.debug(
                      ...
                      typeof C == 'string' ? C.split('').map((W) => W.charCodeAt(0)) : C
                    ),
                  this._parseBuffer.length < C.length &&
                    this._parseBuffer.length < b &&
                    (this._parseBuffer = new Uint32Array(Math.min(C.length, b))),
                  ...
                  for (let W = H; W < C.length; W += b) {
                    const z = W + b < C.length ? W + b : C.length,
                      S =
                        typeof C == 'string'
                          ? this._stringDecoder.decode(C.substring(W, z), this._parseBuffer)
                          : this._utf8Decoder.decode(C.subarray(W, z), this._parseBuffer)
                    if ((E = this._parser.parse(this._parseBuffer, S)))
                      return (this._preserveStack(D, P, S, W), this._logSlowResolvingAsync(E), E)
                  }
                else if (!U) {
                  const W =
                    typeof C == 'string'
                  ...
                  if ((E = this._parser.parse(this._parseBuffer, W)))
                    return (this._preserveStack(D, P, W, 0), this._logSlowResolvingAsync(E), E)
                }
                ;((this._activeBuffer.x === D && this._activeBuffer.y === P) ||
              ...
              print(C, w, E) {
                ...
                ;(this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                  this._activeBuffer.x &&
                    ...
                    B.setCellFromCodePoint(this._activeBuffer.x - 1, 0, 1, R.fg, R.bg, R.extended))
                for (let A = w; A < E; ++A) {
                  if (((D = C[A]), (P = this._unicodeService.wcwidth(D)), D < 127 && H)) {
                    const N = H[String.fromCharCode(D)]
                    N && (D = N.charCodeAt(0))
                  }
                  if (
                    (U && this._onA11yChar.fire((0, u.stringFromCodePoint)(D)),
                    ...
                    if (this._activeBuffer.x + P - 1 >= W) {
                      ...
                      } else if (((this._activeBuffer.x = W - 1), P === 2)) continue
                    }
                    if (
                      (S &&
                        (B.insertCells(
                      ...
                      for (; --P; )
                        B.setCellFromCodePoint(this._activeBuffer.x++, 0, 0, R.fg, R.bg, R.extended)
                  } else
                ...
                ;(E - w > 0 &&
                  ...
                  this._workCell.getWidth() === 2 || this._workCell.getCode() > 65535
                  ...
                  this._activeBuffer.x < W &&
                    ...
                    B.setCellFromCodePoint(this._activeBuffer.x, 0, 1, R.fg, R.bg, R.extended),
                  this._dirtyRowTracker.markDirty(this._activeBuffer.y))
              }
              registerCsiHandler(C, w) {
                return C.final !== 't' || C.prefix || C.intermediates
                  ...
                  : this._parser.registerCsiHandler(
                      C,
                      (E) => !L(E.params[0], this._optionsService.rawOptions.windowOptions) || w(E)
                    )
              }
              ...
              _setCursor(C, w) {
                ;(this._dirtyRowTracker.markDirty(this._activeBuffer.y),
                  this._coreService.decPrivateModes.origin
                    ...
                    : ((this._activeBuffer.x = C), (this._activeBuffer.y = w)),
                  this._restrictCursor(),
                  this._dirtyRowTracker.markDirty(this._activeBuffer.y))
              }
              _moveCursor(C, w) {
                ;(this._restrictCursor(),
                  this._setCursor(this._activeBuffer.x + C, this._activeBuffer.y + w))
              }
              cursorUp(C) {
              ...
              _resetBufferLine(C, w = !1) {
                ...
                E &&
                  (E.fill(this._activeBuffer.getNullCell(this._eraseAttrData()), w),
                ...
                switch ((this._restrictCursor(this._bufferService.cols), C.params[0])) {
                  ...
                  case 1:
                    for (
                      E = this._activeBuffer.y,
                        this._dirtyRowTracker.markDirty(E),
                        this._eraseInBufferLine(E, 0, this._activeBuffer.x + 1, !0, w),
              ...
              insertLines(C) {
                ...
                const E = this._activeBuffer.ybase + this._activeBuffer.y,
                  ...
                  P = this._bufferService.rows - 1 + this._activeBuffer.ybase - D + 1
                for (; w--; )
                ...
                for (; w--; )
                  (this._activeBuffer.lines.splice(
                    ...
                    this._activeBuffer.lines.splice(
                      this._activeBuffer.ybase + this._activeBuffer.scrollTop,
                      0,
                      this._activeBuffer.getBlankLine(e.DEFAULT_ATTR_DATA)
                    ))
                return (
                  this._dirtyRowTracker.markRangeDirty(
                    this._activeBuffer.scrollTop,
              ...
              repeatPrecedingCharacter(C) {
                ...
                const w = C.params[0] || 1,
                  E = new Uint32Array(w)
                for (let D = 0; D < w; ++D) E[D] = this._parser.precedingCodepoint
              ...
              requestMode(C, w) {
                const E = this._coreService.decPrivateModes,
                  { activeProtocol: D, activeEncoding: P } = this._coreMouseService,
                  H = this._coreService,
                                                        ...
                                                        : A === 1016
                                                          ...
                                                          : A === 1048
                                                            ...
                                                            : A === 47 || A === 1047 || A === 1049
                                                              ? B(z === S)
                                                              : A === 2004
                                                                ? B(E.bracketedPasteMode)
                                                                : 0),
                  H.triggerDataEvent(`${n.C0.ESC}[${w ? '' : '?'}${N};${F}$y`),
                  !0
                )
                var N, F
              }
              _updateAttrColor(C, w, E, D, P) {
                return (
                  w === 2
                    ...
                    : w === 5 && ((C &= -50331904), (C |= 33554432 | (255 & E))),
                  C
                )
              }
              _extractColor(C, w, E) {
                ...
                let P = 0,
                  H = 0
                do {
                  if (((D[H + P] = C.params[w + H]), C.hasSubParams(w + H))) {
                  ...
                  if ((D[1] === 5 && H + P >= 2) || (D[1] === 2 && H + P >= 5)) break
                  D[1] && (P = 1)
                } while (++H + w < C.length && H + P < D.length)
                for (let U = 2; U < D.length; ++U) D[U] === -1 && (D[U] = 0)
                switch (D[0]) {
                  case 38:
                                  ...
                                  : E === 4
                                    ? ((D.fg |= 268435456),
                                      this._processUnderline(
                                        C.hasSubParams(P) ? C.getSubParams(P)[0] : 1,
                                        D
                                      ))
                                    : E === 5
                                      ? (D.fg |= 536870912)
                                                            ...
                                                            : E === 29
                                                              ...
                                                              : E === 39
                                                                ? ((D.fg &= -67108864),
                                                                  (D.fg |=
                                                                    16777215 &
                                                                    e.DEFAULT_ATTR_DATA.fg))
                                                                : E === 49
                                                                  ? ((D.bg &= -67108864),
                                                                    (D.bg |=
                                                                      16777215 &
                                                                      e.DEFAULT_ATTR_DATA.bg))
                                                                  : E === 38 || E === 48 || E === 58
                                                                    ? (P += this._extractColor(
                                                                        C,
                                                                        P,
                                                                        D
                                                                      ))
              ...
              setScrollRegion(C) {
                ...
                let E
                return (
                  (C.length < 2 || (E = C.params[1]) > this._bufferService.rows || E === 0) &&
                    (E = this._bufferService.rows),
                  E > w &&
              ...
              setHyperlink(C) {
                ...
                return (
                  !(w.length < 2) &&
                  (w[1] ? this._createHyperlink(w[0], w[1]) : !w[0] && this._finishHyperlink())
                )
              }
              ...
              _setOrReportSpecialColor(C, w) {
                ...
                for (let D = 0; D < E.length && !(w >= this._specialColors.length); ++D, ++w)
                  if (E[D] === '?') this._onColor.fire([{ type: 0, index: this._specialColors[w] }])
                  else {
                    const P = (0, h.parseColor)(E[D])
                    P && this._onColor.fire([{ type: 1, index: this._specialColors[w], color: P }])
                  }
                return !0
              }
              ...
              screenAlignmentPattern() {
                ...
                for (let w = 0; w < this._bufferService.rows; ++w) {
                  const E = this._activeBuffer.ybase + this._activeBuffer.y + w,
              ...
              requestStatusString(C, w) {
                ...
                return ((P) => (
                  this._coreService.triggerDataEvent(`${n.C0.ESC}${P}${n.C0.ESC}\\`),
                  !0
                ))(
                  C === '"q'
            ...
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              ...
              (r.MutableDisposable = class {
                ...
                set value(c) {
                  ...
                  this._isDisposed ||
                    c === this._value ||
                    ((_ = this._value) === null || _ === void 0 || _.dispose(), (this._value = c))
                }
                clear() {
                  this.value = void 0
                }
          ...
          6114: (I, r) => {
            ...
            ;((r.isFirefox = a.includes('Firefox')),
              ...
              (r.isMac = ['Macintosh', 'MacIntel', 'MacPPC', 'Mac68K'].includes(c)),
              (r.isIpad = c === 'iPad'),
              (r.isIphone = c === 'iPhone'),
              (r.isWindows = ['Windows', 'Win16', 'Win32', 'WinCE'].includes(c)),
          ...
          6106: (I, r) => {
            ...
            r.SortedList = class {
              ...
              insert(c) {
                this._array.length !== 0
                  ? ((a = this._search(this._getKey(c))), this._array.splice(a, 0, c))
                  : this._array.push(c)
              }
              delete(c) {
                ...
                if (
                  ...
                  return !1
                do if (this._array[a] === c) return (this._array.splice(a, 1), !0)
              ...
              *getKeyIterator(c) {
                if (
                  this._array.length !== 0 &&
                  ((a = this._search(c)),
                  !(a < 0 || a >= this._array.length) && this._getKey(this._array[a]) === c)
                )
            ...
            ;((r.MAX_BUFFER_SIZE = 4294967295),
              (r.Buffer = class {
                ...
                resize(t, i) {
                  ...
                  if (
                    (v > this.lines.maxLength && (this.lines.maxLength = v), this.lines.length > 0)
                  ) {
                    if (this._cols < t)
                      ...
                      for (let h = this._rows; h < i; h++)
                        this.lines.length < i + this.ybase &&
                          ...
                          this._optionsService.rawOptions.windowsPty.buildNumber !== void 0
                            ...
                            : this.ybase > 0 && this.lines.length <= this.ybase + this.y + m + 1
                              ? (this.ybase--, m++, this.ydisp > 0 && this.ydisp--)
                              : this.lines.push(new d.BufferLine(t, o)))
                    else
                      for (let h = this._rows; h > i; h--)
                        this.lines.length > i + this.ybase &&
                  ...
                  if (
                    ...
                    this._isReflowEnabled && (this._reflow(t, i), this._cols > t))
                  )
                    for (let m = 0; m < this.lines.length; m++) l += +this.lines.get(m).resize(t, o)
                  ;((this._cols = t),
                    (this._rows = i),
                ...
                _batchedMemoryCleanup() {
                  ...
                  for (; this._memoryCleanupPosition < this.lines.length; )
                    if (
                      ((i += this.lines.get(this._memoryCleanupPosition++).cleanupMemory()),
                      i > 100)
                    )
                      return !0
                  return t
                ...
                _reflow(t, i) {
                  this._cols !== t &&
                    (t > this._cols ? this._reflowLarger(t, i) : this._reflowSmaller(t, i))
                }
                _reflowLarger(t, i) {
                  ...
                  if (o.length > 0) {
                    ...
                    ;((0, f.reflowLargerApplyNewLayout)(this.lines, l.layout),
                      this._reflowLargerAdjustViewport(t, i, l.countRemoved))
                  }
                }
                _reflowLargerAdjustViewport(t, i, o) {
                  ...
                  for (; v-- > 0; )
                    this.ybase === 0
                      ? (this.y > 0 && this.y--,
                        this.lines.length < i && this.lines.push(new d.BufferLine(t, l)))
                ...
                _reflowSmaller(t, i) {
                  ...
                  for (let m = this.lines.length - 1; m >= 0; m--) {
                    ...
                    const L = g[g.length - 1].getTrimmedLength(),
                      y = (0, f.reflowSmallerGetNewLineLengths)(g, this._cols, t),
                      k = y.length - g.length
                    let x
                    x =
                      this.ybase === 0 && this.y !== this.lines.length - 1
                        ? Math.max(0, this.y - this.lines.maxLength + k)
                        : Math.max(0, this.lines.length - this.lines.maxLength + k)
                    const T = []
                    for (let D = 0; D < k; D++) {
                    ...
                    ;(T.length > 0 &&
                      (l.push({ start: m + g.length + v, newLines: T }), (v += T.length)),
                      g.push(...T))
                    let O = y.length - 1,
                      M = y[O]
                    M === 0 && (O--, (M = y[O]))
                    ...
                    for (; C >= 0; ) {
                      ...
                      if (
                        ...
                        w = (0, f.getWrappedLineTrimmedLength)(g, P, this._cols)
                      }
                    }
                    for (let D = 0; D < g.length; D++) y[D] < t && g[D].setCell(y[D], o)
                    let E = k - x
                    for (; E-- > 0; )
                      this.ybase === 0
                        ? this.y < i - 1
                          ...
                          : (this.ybase++, this.ydisp++)
                        : this.ybase < Math.min(this.lines.maxLength, this.lines.length + v) - i &&
                  ...
                  if (l.length > 0) {
                    ...
                    let k = 0
                    for (let O = Math.min(this.lines.maxLength - 1, g + v - 1); O >= 0; O--)
                      if (y && y.start > b + k) {
                        for (let M = y.newLines.length - 1; M >= 0; M--)
                          this.lines.set(O--, y.newLines[M])
                        ;(O++,
                          m.push({ index: b + 1, amount: y.newLines.length }),
                          (k += y.newLines.length),
                          (y = l[++L]))
                      } else this.lines.set(O, h[b--])
                    let x = 0
                    for (let O = m.length - 1; O >= 0; O--)
                      ((m[O].index += x), this.lines.onInsertEmitter.fire(m[O]), (x += m[O].amount))
                  ...
                  return (
                    ...
                    i.register(
                      this.lines.onDelete((o) => {
                        ;(i.line >= o.index && i.line < o.index + o.amount && i.dispose(),
                          i.line > o.index && (i.line -= o.amount))
                      })
                    ),
          ...
          8437: (I, r, a) => {
            ...
            class p {
              ...
              get(e) {
                ...
                return [
                  this._data[3 * e + 1],
                  2097152 & s ? this._combined[e] : t ? (0, d.stringFromCodePoint)(t) : '',
                  s >> 22,
                ...
                ;((this._data[3 * e + 1] = s[n.CHAR_DATA_ATTR_INDEX]),
                  s[n.CHAR_DATA_CHAR_INDEX].length > 1
                    ? ((this._combined[e] = s[1]),
                      (this._data[3 * e + 0] = 2097152 | e | (s[n.CHAR_DATA_WIDTH_INDEX] << 22)))
                    : (this._data[3 * e + 0] =
              ...
              loadCell(e, s) {
                return (
                  ...
                  (s.fg = this._data[f + 1]),
                  (s.bg = this._data[f + 2]),
                  2097152 & s.content && (s.combinedData = this._combined[e]),
                  268435456 & s.bg && (s.extended = this._extendedAttrs[e]),
                  s
                )
              }
              setCell(e, s) {
                ;(2097152 & s.content && (this._combined[e] = s.combinedData),
              ...
              addCodepointToCell(e, s) {
                ...
                2097152 & t
                  ...
                  : (2097151 & t
                      ? ((this._combined[e] =
                          (0, d.stringFromCodePoint)(2097151 & t) + (0, d.stringFromCodePoint)(s)),
                        (t &= -2097152),
                        (t |= 2097152))
                      : (t = s | 4194304),
                    (this._data[3 * e + 0] = t))
              ...
              copyCellsFrom(e, s, t, i, o) {
                ...
                if (o)
                  for (let m = i - 1; m >= 0; m--) {
                    ...
                    268435456 & l[3 * (s + m) + 2] &&
                      (this._extendedAttrs[t + m] = e._extendedAttrs[s + m])
                  }
                else
                  for (let m = 0; m < i; m++) {
                    for (let h = 0; h < 3; h++) this._data[3 * (t + m) + h] = l[3 * (s + m) + h]
          ...
          4634: (I, r) => {
            function a(c, _, n) {
              ...
              const d = !c[_].hasContent(n - 1) && c[_].getWidth(n - 1) === 1,
            ...
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              ...
              (r.reflowLargerGetLinesToRemove = function (c, _, n, d, f) {
                ...
                for (let u = 0; u < c.length - 1; u++) {
                  ...
                  let m = 0
                  for (let h = t.length - 1; h > 0 && (h > i || t[h].getTrimmedLength() === 0); h--)
                    m++
            ...
            class d extends n.AttributeData {
              ...
              setFromCharData(p) {
                ...
                if (p[_.CHAR_DATA_CHAR_INDEX].length > 2) u = !0
                  ...
                  this.content =
                    p[_.CHAR_DATA_CHAR_INDEX].charCodeAt(0) | (p[_.CHAR_DATA_WIDTH_INDEX] << 22)
                u &&
                  ((this.combinedData = p[_.CHAR_DATA_CHAR_INDEX]),
                  (this.content = 2097152 | (p[_.CHAR_DATA_WIDTH_INDEX] << 22)))
              }
              getAsCharData() {
                return [this.fg, this.getChars(), this.getWidth(), this.getCode()]
              }
...
`),
                ...
                case 37:
                  ...
                  e
                    ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'D'),
                      u.key === c.C0.ESC + '[1;3D' && (u.key = c.C0.ESC + (f ? 'b' : '[1;5D')))
                    : (u.key = d ? c.C0.ESC + 'OD' : c.C0.ESC + '[D')
                  break
                case 39:
                  if (n.metaKey) break
                  e
                    ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'C'),
                      u.key === c.C0.ESC + '[1;3C' && (u.key = c.C0.ESC + (f ? 'f' : '[1;5C')))
                    : (u.key = d ? c.C0.ESC + 'OC' : c.C0.ESC + '[C')
                  break
                case 38:
                  if (n.metaKey) break
                  e
                    ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'A'),
                      f || u.key !== c.C0.ESC + '[1;3A' || (u.key = c.C0.ESC + '[1;5A'))
                    : (u.key = d ? c.C0.ESC + 'OA' : c.C0.ESC + '[A')
                  break
                case 40:
                  if (n.metaKey) break
                  e
                    ? ((u.key = c.C0.ESC + '[1;' + (e + 1) + 'B'),
                      f || u.key !== c.C0.ESC + '[1;3B' || (u.key = c.C0.ESC + '[1;5B'))
                    : (u.key = d ? c.C0.ESC + 'OB' : c.C0.ESC + '[B')
                  break
                case 45:
                ...
                default:
                  if (!n.ctrlKey || n.shiftKey || n.altKey || n.metaKey)
                    if ((f && !p) || !n.altKey || n.metaKey)
                      !f || n.altKey || n.ctrlKey || n.shiftKey || !n.metaKey
                        ? n.key &&
                          !n.ctrlKey &&
                          !n.altKey &&
                          !n.metaKey &&
                    ...
                    n.keyCode >= 65 && n.keyCode <= 90
                      ...
                      : n.keyCode === 32
                        ...
                        : n.keyCode >= 51 && n.keyCode <= 55
                          ? (u.key = String.fromCharCode(n.keyCode - 51 + 27))
                          : n.keyCode === 56
                            ? (u.key = c.C0.DEL)
                            : n.keyCode === 219
                              ? (u.key = c.C0.ESC)
          ...
          482: (I, r) => {
            ;(Object.defineProperty(r, '__esModule', { value: !0 }),
              (r.Utf8ToUtf32 = r.StringToUtf32 = r.utf32ToString = r.stringFromCodePoint = void 0),
              ...
              (r.StringToUtf32 = class {
                ...
                decode(a, c) {
                  ...
                  if (this._interim) {
                    ...
                    ;(56320 <= f && f <= 57343
                      ? (c[n++] = 1024 * (this._interim - 55296) + f - 56320 + 65536)
                  ...
                  for (let f = d; f < _; ++f) {
                    ...
                    if (55296 <= p && p <= 56319) {
                      ...
                      56320 <= u && u <= 57343
                        ? (c[n++] = 1024 * (p - 55296) + u - 56320 + 65536)
                        : ((c[n++] = p), (c[n++] = u))
                    } else p !== 65279 && (c[n++] = p)
                  }
                  return n
                ...
                decode(a, c) {
                    ...
                    ;(o ||
                      (h === 2
                        ? l < 128
                          ...
                          : (c[u++] = l)
                        : h === 3
                          ? l < 2048 || (l >= 55296 && l <= 57343) || l === 65279 || (c[u++] = l)
                  ...
                  for (; i < _; ) {
                    ...
                    if (((n = a[i++]), n < 128)) c[u++] = n
                      ...
                      if (
                        ((e = ((15 & n) << 12) | ((63 & d) << 6) | (63 & f)),
                        e < 2048 || (e >= 55296 && e <= 57343) || e === 65279)
                      )
                        continue
                      c[u++] = e
                    } else if ((248 & n) == 240) {
                  ...
                  : n < 127
                    ...
                    : n < 65536
                      ...
                      : (function (d, f) {
                        ...
                        ? 0
                        : (n >= 131072 && n <= 196605) || (n >= 196608 && n <= 262141)
                          ? 2
                          : 1
              }
            }
            ...
            ;((r.parseColor = function (n) {
              ...
              if (d.indexOf('rgb:') === 0) {
                ...
                if (f) {
                  ...
                  return [
                    Math.round((parseInt(f[1] || f[4] || f[7] || f[10], 16) / p) * 255),
                    Math.round((parseInt(f[2] || f[5] || f[8] || f[11], 16) / p) * 255),
                    Math.round((parseInt(f[3] || f[6] || f[9] || f[12], 16) / p) * 255)
                  ]
                }
              } else if (
                d.indexOf('#') === 0 &&
                ((d = d.slice(1)), c.exec(d) && [3, 6, 9, 12].includes(d.length))
              ) {
                const f = d.length / 3,
                  p = [0, 0, 0]
                for (let u = 0; u < 3; ++u) {
          ...
          6351: (I, r, a) => {
            ...
            r.DcsParser = class {
              ...
              hook(p, u) {
                if (
                  ...
                  for (let e = this._active.length - 1; e >= 0; e--) this._active[e].hook(u)
                else this._handlerFb(this._ident, 'HOOK', u)
              }
              put(p, u, e) {
                if (this._active.length)
                  for (let s = this._active.length - 1; s >= 0; s--) this._active[s].put(p, u, e)
                else this._handlerFb(this._ident, 'PUT', (0, c.utf32ToString)(p, u, e))
              }
              unhook(p, u = !0) {
                if (this._active.length) {
                  let e = !1,
                  ...
                  if (
                    ...
                    for (; s >= 0 && ((e = this._active[s].unhook(p)), e !== !0); s--)
                  ...
                  for (; s >= 0; s--)
                    if (((e = this._active[s].unhook(!1)), e instanceof Promise))
                      return (
                        (this._stack.paused = !0),
                        (this._stack.loopPosition = s),
            ...
            ;(f.addParam(0),
              (r.DcsHandler = class {
                ...
                hook(p) {
                  ;((this._params = p.length > 1 || p.params[0] ? p.clone() : f),
                    (this._data = ''),
                    (this._hitLimit = !1))
                }
                put(p, u, e) {
                ...
                unhook(p) {
                  ...
                  if (this._hitLimit) u = !1
                    ...
                    p &&
                    ((u = this._handler(this._data, this._params)), u instanceof Promise)
                  )
                    return u.then(
                      (e) => ((this._params = f), (this._data = ''), (this._hitLimit = !1), e)
                    )
            ...
            class u extends c.Disposable {
              ...
              _identifier(s, t = [64, 126]) {
                ...
                if (s.prefix) {
                  ...
                  if (((i = s.prefix.charCodeAt(0)), (i && 60 > i) || i > 63))
              ...
              parse(s, t, i) {
                ...
                if (this._parseStack.state)
                  if (this._parseStack.state === 2)
                    ...
                    switch (this._parseStack.state) {
                      case 3:
                        if (i === !1 && g > -1) {
                          for (; g >= 0 && ((o = h[g](this._params)), o !== !0); g--)
                            if (o instanceof Promise) return ((this._parseStack.handlerPos = g), o)
                        }
                      ...
                      case 6:
                        if (
                          ...
                          (o = this._dcsParser.unhook(l !== 24 && l !== 26, i)),
                          o)
                        )
                          return o
                      ...
                      case 5:
                        if (
                          ((l = s[this._parseStack.chunkPos]),
                          (o = this._oscParser.end(l !== 24 && l !== 26, i)),
                          o)
                        )
                          return o
                        ;(l === 27 && (this._parseStack.transition |= 1),
                ...
                for (let h = m; h < t; ++h) {
                  switch (
                    ((l = s[h]),
                    (v = this._transitions.table[(this.currentState << 8) | (l < 160 ? l : p)]),
                    v >> 4)
                  ) {
                    case 2:
                      for (let k = h + 1; ; ++k) {
                        if (k >= t || (l = s[k]) < 32 || (l > 126 && l < p)) {
                    ...
                    case 1:
                      ...
                      break
                    case 7:
                      const g = this._csiHandlers[(this._collect << 8) | l]
                      let b = g ? g.length - 1 : -1
                      for (; b >= 0 && ((o = g[b](this._params)), o !== !0); b--)
                        if (o instanceof Promise) return (this._preserveStack(3, g, b, v, h), o)
                      ;(b < 0 && this._csiHandlerFb((this._collect << 8) | l, this._params),
                        (this.precedingCodepoint = 0))
                      break
                    case 8:
                      do
                    ...
                    case 10:
                      ...
                      for (; y >= 0 && ((o = L[y]()), o !== !0); y--)
                        if (o instanceof Promise) return (this._preserveStack(4, L, y, v, h), o)
                      ;(y < 0 && this._escHandlerFb((this._collect << 8) | l),
                        (this.precedingCodepoint = 0))
                      break
                    case 11:
                    ...
                    case 13:
                      ...
                      break
                    case 14:
                      if (((o = this._dcsParser.unhook(l !== 24 && l !== 26)), o))
                    ...
                    case 5:
                      for (let k = h + 1; ; k++)
                        if (k >= t || (l = s[k]) < 32 || (l > 127 && l < p)) {
                          ;(this._oscParser.put(s, h, k), (h = k - 1))
                          break
                        }
                      break
                    case 6:
                      if (((o = this._oscParser.end(l !== 24 && l !== 26)), o))
          ...
          6242: (I, r, a) => {
            ...
            ;((r.OscParser = class {
              ...
              _put(d, f, p) {
                if (this._active.length)
                  for (let u = this._active.length - 1; u >= 0; u--) this._active[u].put(d, f, p)
                  ...
                  if (this._state !== 3)
                    if ((this._state === 1 && this._start(), this._active.length)) {
                      ...
                      if (
                        ...
                        for (; u >= 0 && ((p = this._active[u].end(d)), p !== !0); u--)
                      ...
                      for (; u >= 0; u--)
                        if (((p = this._active[u].end(!1)), p instanceof Promise))
                          return (
                            (this._stack.paused = !0),
                            (this._stack.loopPosition = u),
                            (this._stack.fallThrough = !0),
              ...
              (r.OscHandler = class {
                ...
                put(d, f, p) {
                  ...
                  if (this._hitLimit) f = !1
                    ...
                    return f.then((p) => ((this._data = ''), (this._hitLimit = !1), p))
            ...
            let u = (r.BufferService = class extends d.Disposable {
              ...
              constructor(e) {
                ;(super(),
                  ...
                  (this.onScroll = this._onScroll.event),
                  (this.cols = Math.max(e.rawOptions.cols || 0, r.MINIMUM_COLS)),
                  (this.rows = Math.max(e.rawOptions.rows || 0, r.MINIMUM_ROWS)),
                  (this.buffers = this.register(new f.BufferSet(e, this))))
              }
              resize(e, s) {
                ;((this.cols = e),
                  (this.rows = s),
              ...
              scroll(e, s = !1) {
                ...
                ;((i = this._cachedBlankLine),
                  (i && i.length === this.cols && i.getFg(0) === e.fg && i.getBg(0) === e.bg) ||
                    ((i = t.getBlankLine(e, s)), (this._cachedBlankLine = i)),
                  (i.isWrapped = s))
                ...
                if (t.scrollTop === 0) {
                  ...
                  ;(l === t.lines.length - 1
                    ...
                    v
                      ? this.isUserScrolling && (t.ydisp = Math.max(t.ydisp - 1, 0))
          ...
          1753: function (I, r, a) {
            ...
            const n = a(2585),
              ...
              p = {
                ...
                DRAG: { events: 23, restrict: (i) => i.action !== 32 || i.button !== 3 },
              ...
              return (
                i.button === 4
                  ...
                  : ((l |= 3 & i.button),
                    4 & i.button && (l |= 64),
                    8 & i.button && (l |= 128),
                    i.action === 32 ? (l |= 32) : i.action !== 0 || o || (l |= 3)),
                l
              )
            }
            ...
            let t = (r.CoreMouseService = class extends f.Disposable {
              ...
              triggerMouseEvent(i) {
                if (
                  ...
                  (i.button !== 4 && (i.action === 2 || i.action === 3)) ||
                  (i.col++,
                  i.row++,
                  i.action === 32 &&
                    this._lastEvent &&
                    this._equalEvents(this._lastEvent, i, this._activeEncoding === 'SGR_PIXELS')) ||
          ...
          6975: function (I, r, a) {
            var c =
                ...
                function (t, i, o, l) {
                  var v,
                    m = arguments.length,
                    h = m < 3 ? i : l === null ? (l = Object.getOwnPropertyDescriptor(i, o)) : l
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    h = Reflect.decorate(t, i, o, l)
                  else
                    for (var g = t.length - 1; g >= 0; g--)
                      (v = t[g]) && (h = (m < 3 ? v(h) : m > 3 ? v(i, o, h) : v(i, o)) || h)
            ...
            r.CoreService = s = c(
              [_(0, p.IBufferService), _(1, p.ILogService), _(2, p.IOptionsService)],
              s
            )
          },
          9074: (I, r, a) => {
            ...
            class u extends n.Disposable {
              ...
              constructor() {
                ;(super(),
                  (this._decorations = new d.SortedList((t) => t?.marker.line)),
              ...
              registerDecoration(t) {
                ...
                if (i) {
                  ...
                  ;(i.onDispose(() => {
                    i &&
                      (this._decorations.delete(i) && this._onDecorationRemoved.fire(i),
                      o.dispose())
                  }),
              ...
              *getDecorationsAtCell(t, i, o) {
                ...
                for (const b of this._decorations.getKeyIterator(i))
                  ((h = (l = b.options.x) !== null && l !== void 0 ? l : 0),
                    (g = h + ((v = b.options.width) !== null && v !== void 0 ? v : 1)),
                    t >= h &&
                      t < g &&
                      (!o ||
                        ((m = b.options.layer) !== null && m !== void 0 ? m : 'bottom') === o) &&
                      (yield b))
              }
              forEachDecorationAtCell(t, i, o, l) {
                this._decorations.forEachByKey(i, (v) => {
                  var m, h, g
                  ;((f = (m = v.options.x) !== null && m !== void 0 ? m : 0),
                    (p = f + ((h = v.options.width) !== null && h !== void 0 ? h : 1)),
                    t >= f &&
                      t < p &&
                      (!o ||
                        ((g = v.options.layer) !== null && g !== void 0 ? g : 'bottom') === o) &&
                      l(v))
                })
              }
            }
                ...
                return (
                  this._cachedBg === null &&
                    (this.options.backgroundColor
                      ? (this._cachedBg = c.css.toColor(this.options.backgroundColor))
          ...
          4348: (I, r, a) => {
            ...
            ;((r.ServiceCollection = n),
              (r.InstantiationService = class {
                ...
                createInstance(d, ...f) {
                  const p = (0, _.getServiceDependencies)(d).sort((s, t) => s.index - t.index),
                    u = []
                  for (const s of p) {
          ...
          7866: function (I, r, a) {
              ...
              u = (r.LogService = class extends n.Disposable {
                ...
                trace(e, ...s) {
                  ...
                  this._logLevel <= d.LogLevelEnum.TRACE &&
                    this._log(
                      (i =
                        (t = this._optionsService.options.logger) === null || t === void 0
                          ? void 0
                          : t.trace.bind(this._optionsService.options.logger)) !== null &&
                        i !== void 0
                        ? i
                        : console.log,
                      e,
                  ...
                  this._logLevel <= d.LogLevelEnum.DEBUG &&
                    this._log(
                      (i =
                        (t = this._optionsService.options.logger) === null || t === void 0
                          ? void 0
                          : t.debug.bind(this._optionsService.options.logger)) !== null &&
                        i !== void 0
                        ? i
                        : console.log,
                      e,
                  ...
                  this._logLevel <= d.LogLevelEnum.INFO &&
                    this._log(
                      (i =
                        (t = this._optionsService.options.logger) === null || t === void 0
                          ? void 0
                          : t.info.bind(this._optionsService.options.logger)) !== null &&
                        i !== void 0
                        ? i
                        : console.info,
                      e,
                  ...
                  this._logLevel <= d.LogLevelEnum.WARN &&
                    this._log(
                      (i =
                        (t = this._optionsService.options.logger) === null || t === void 0
                          ? void 0
                          : t.warn.bind(this._optionsService.options.logger)) !== null &&
                        i !== void 0
                        ? i
                        : console.warn,
                      e,
                  ...
                  this._logLevel <= d.LogLevelEnum.ERROR &&
                    this._log(
                      (i =
                        (t = this._optionsService.options.logger) === null || t === void 0
                          ? void 0
                          : t.error.bind(this._optionsService.options.logger)) !== null &&
                        i !== void 0
                        ? i
                        : console.error,
                      e,
            ...
            ;((r.LogService = u = c([_(0, d.IOptionsService)], u)),
              ...
              (r.traceCall = function (e, s, t) {
                ...
                const i = t.value
                t.value = function (...o) {
                  if (p.logLevel !== d.LogLevelEnum.TRACE) return i.apply(this, o)
                  p.trace(`GlyphRenderer#${i.name}(${o.map((v) => JSON.stringify(v)).join(', ')})`)
                ...
                const u = (s) => {
                  ...
                  e = (s, t) => {
                    ...
                    ;((t = this._sanitizeAndValidateOption(s, t)),
                      this.rawOptions[s] !== t &&
                        ((this.rawOptions[s] = t), this._onOptionChange.fire(s)))
                  }
          ...
          2660: function (I, r, a) {
            var c =
                ...
                function (f, p, u, e) {
                  var s,
                    t = arguments.length,
                    i = t < 3 ? p : e === null ? (e = Object.getOwnPropertyDescriptor(p, u)) : e
                  if (typeof Reflect == 'object' && typeof Reflect.decorate == 'function')
                    i = Reflect.decorate(f, p, u, e)
                  else
                    for (var o = f.length - 1; o >= 0; o--)
                      (s = f[o]) && (i = (t < 3 ? s(i) : t > 3 ? s(p, u, i) : s(p, u)) || i)
            ...
            let d = (r.OscLinkService = class {
              ...
              registerLink(f) {
                ...
                const t = p.addMarker(p.ybase + p.y),
                  i = { id: this._nextId++, key: this._getEntryIdKey(u), data: u, lines: [t] }
                return (
          ...
          2585: (I, r, a) => {
            ...
            ;((r.IBufferService = (0, c.createDecorator)('BufferService')),
              (r.ICoreMouseService = (0, c.createDecorator)('CoreMouseService')),
              (r.ICoreService = (0, c.createDecorator)('CoreService')),
              (r.ICharsetService = (0, c.createDecorator)('CharsetService')),
              (r.IInstantiationService = (0, c.createDecorator)('InstantiationService')),
              (function (n) {
                ;((n[(n.TRACE = 0)] = 'TRACE'),
                  (n[(n.DEBUG = 1)] = 'DEBUG'),
                  (n[(n.INFO = 2)] = 'INFO'),
              ...
              (r.IOptionsService = (0, c.createDecorator)('OptionsService')),
              (r.IOscLinkService = (0, c.createDecorator)('OscLinkService')),
              (r.IUnicodeService = (0, c.createDecorator)('UnicodeService')),
              (r.IDecorationService = (0, c.createDecorator)('DecorationService')))
          },
          1480: (I, r, a) => {
...
var pe = ve.exports
const be = Se(pe),
  we = Ce({ __proto__: null, default: be }, [pe])
export { we as x }
